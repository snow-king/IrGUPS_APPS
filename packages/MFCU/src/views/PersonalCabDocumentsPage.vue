<template>
  <div class="mt-20 mx-1 md:mx-20 md:p-10 bg-gray-50 rounded-md">
    <div class="flex text-xl font-semibold break-all pl-4 p-1 dark:text-white">
    ...
    >
      <div class="flex w-full justify-around">
        <select
          class="block p-2 h-10 w-1/5 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        >
