import {
    $ as deletePropertyOrThrow$1,
    _ as _export,
    A as fails$3,
    a as combineParameters,
    a0 as arrayMethodHasSpeciesSupport$1,
    a1 as toAbsoluteIndex$1,
    a2 as toLength$2,
    a3 as objectGetOwnPropertyNames,
    a4 as objectDefineProperty,
    a5 as createNonEnumerableProperty$1,
    a6 as defineBuiltIns$1,
    a7 as anInstance$1,
    a8 as objectGetPrototypeOf,
    a9 as objectSetPrototypeOf,
    aa as arrayFill$1,
    ab as setToStringTag$1,
    ac as functionName,
    ad as arraySliceSimple,
    ae as internalState,
    af as setSpecies$1,
    ag as objectGetOwnPropertyNamesExternal,
    ah as memoize$3,
    ai as dist,
    aj as lib,
    ak as filterArgTypes,
    al as fastDeepEqual,
    am as NAVIGATE_URL,
    b as browser,
    d as dedent$2,
    ...
    m as mapValues_1,
    n as descriptors,
    p as createProperty$1,
    R as global$4,
    T as stringTrim,
    U as stringTrimForced,
    v as toString$3,
    V as isArray$b,
    W as toObject$1,
    w as window_1$2,
    x as requireObjectCoercible$1,
    X as lengthOfArrayLike$1,
    Y as doesNotExceedSafeInteger$1,
    y as toIntegerOrInfinity$3,
    z as functionUncurryThis,
    Z as arraySpeciesCreate$1,
...
import {
    ...
    r as react,
    R as React__default,
} from "./jsx-runtime.9dff8acf.js";
import {s as str} from "./string.dd967029.js";
import "./es.map.constructor.3fc5bb37.js";
import {s as stringRepeat} from "./es.number.to-fixed.04f7b86b.js";

function _defineProperty$6(ee, _, te) {
  return (
    _ in ee
      ? Object.defineProperty(ee, _, {
          value: te,
          enumerable: !0,
          configurable: !0,
          writable: !0,
    ...
    _ % 2
      ...
      : ownKeys(Object(te)).forEach(function (re) {
          Object.defineProperty(
            ee,
            re,
            Object.getOwnPropertyDescriptor(te, re)
          );
        });
  }
  return ee;
...
function _objectWithoutProperties$2(ee, _) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (ae = 0; ae < ne.length; ae++)
      (re = ne[ae]),
        !(_.indexOf(re) >= 0) &&
          (!Object.prototype.propertyIsEnumerable.call(ee, re) ||
            (te[re] = ee[re]));
  }
  return te;
}
var isFunction$3 = function (_) {
  ...
  useMDXComponents = function (_) {
    ...
    return (
      _ &&
        (re = isFunction$3(_)
          ? _(te)
          : _objectSpread2(_objectSpread2({}, te), _)),
      re
    );
  },
  ...
  MDXCreateElement = React__default.forwardRef(function (ee, _) {
    var te = ee.components,
      ...
      ae = ee.originalType,
      ne = ee.parentName,
      oe = _objectWithoutProperties$2(ee, [
        "components",
        "mdxType",
        "originalType",
        "parentName",
      ]),
      ie = useMDXComponents(te),
      le = re,
      ce = ie["".concat(ne, ".").concat(le)] || ie[le] || DEFAULTS[le] || ae;
    return te
      ? jsx(ce, {
          ..._objectSpread2(
            _objectSpread2({ ref: _ }, oe),
            {},
            { components: te }
          ),
        })
      : jsx(ce, { ..._objectSpread2({ ref: _ }, oe) });
  });
...
function createElement(ee, _) {
  ...
  if (typeof ee == "string" || re) {
    ...
    var oe = {};
    for (var ie in _) hasOwnProperty.call(_, ie) && (oe[ie] = _[ie]);
    (oe.originalType = ee),
      (oe[TYPE_PROP_NAME] = typeof ee == "string" ? ee : re),
      (ne[1] = oe);
    for (var le = 2; le < ae; le++) ne[le] = te[le];
    return React__default.createElement.apply(null, ne);
  }
...
var uncurryThis$1 = functionUncurryThis,
  ...
  createHtml = function (ee, _, te, re) {
    var ae = toString$2(requireObjectCoercible(ee)),
      ne = "<" + _;
    return (
      te !== "" &&
        (ne +=
          " " + te + '="' + replace$1(toString$2(re), quot, "&quot;") + '"'),
      ne + ">" + ae + "</" + _ + ">"
    );
  },
  fails$2 = fails$3,
  stringHtmlForced = function (ee) {
...
var $$8 = _export,
  global$3 = global$4;
$$8(
  { global: !0, forced: global$3.globalThis !== global$3 },
  { globalThis: global$3 }
);
var $$7 = _export,
    ...
    splice: function (_, te) {
      ...
      for (
        oe === 0
          ...
          ? ((ie = 0), (le = ae - ne))
          : ((ie = oe - 2),
            (le = min(max(toIntegerOrInfinity$2(te), 0), ae - ne))),
          doesNotExceedSafeInteger(ae + ie - le),
          ce = arraySpeciesCreate(re, le),
          se = 0;
        se < le;
        se++
      )
      ...
      if (((ce.length = le), ie < le)) {
        for (se = ne; se < ae - le; se++)
          (de = se + le),
            (pe = se + ie),
            de in re ? (re[pe] = re[de]) : deletePropertyOrThrow(re, pe);
        ...
        for (se = ae - le; se > ne; se--)
          (de = se + le - 1),
            (pe = se + ie - 1),
            de in re ? (re[pe] = re[de]) : deletePropertyOrThrow(re, pe);
      for (se = 0; se < ie; se++) re[se + ne] = arguments[se + 2];
...
var arrayBufferBasicDetection =
  ...
  log = Math.log,
  LN2 = Math.LN2,
  pack = function (ee, _, te) {
    var re = $Array(te),
      ae = te * 8 - _ - 1,
      ne = (1 << ae) - 1,
      oe = ne >> 1,
      ie = _ === 23 ? pow(2, -24) - pow(2, -77) : 0,
      le = ee < 0 || (ee === 0 && 1 / ee < 0) ? 1 : 0,
      ce = 0,
      se,
      de,
      pe;
      ...
      ee = abs$1(ee),
        ee != ee || ee === 1 / 0
          ...
          : ((se = floor(log(ee) / LN2)),
            (pe = pow(2, -se)),
            ee * pe < 1 && (se--, (pe *= 2)),
            se + oe >= 1 ? (ee += ie / pe) : (ee += ie * pow(2, 1 - oe)),
            ee * pe >= 2 && (se++, (pe /= 2)),
            se + oe >= ne
              ? ((de = 0), (se = ne))
              : se + oe >= 1
              ? ((de = (ee * pe - 1) * pow(2, _)), (se = se + oe))
              : ((de = ee * pow(2, oe - 1) * pow(2, _)), (se = 0)));
      _ >= 8;
  ...
  unpack = function (ee, _) {
    var te = ee.length,
      ...
      ce = le & 127,
      se;
    for (le >>= 7; oe > 0; ) (ce = ce * 256 + ee[ie--]), (oe -= 8);
    for (se = ce & ((1 << -oe) - 1), ce >>= -oe, oe += _; oe > 0; )
      (se = se * 256 + ee[ie--]), (oe -= 8);
    if (ce === 0) ce = 1 - ne;
    else {
      if (ce === ae) return se ? NaN : le ? -1 / 0 : 1 / 0;
  ...
  get$2 = function (ee, _, te, re) {
    var ae = toIndex(te),
      ne = getInternalState(ee);
    if (ae + _ > ne.byteLength) throw RangeError$1(WRONG_INDEX);
    var oe = getInternalState(ne.buffer).bytes,
      ie = ae + ne.byteOffset,
      le = arraySlice(oe, ie, ie + _);
    return re ? le : reverse(le);
  },
  set = function (ee, _, te, re, ae, ne) {
    var oe = toIndex(te),
      ie = getInternalState(ee);
    if (oe + _ > ie.byteLength) throw RangeError$1(WRONG_INDEX);
    for (
      var le = getInternalState(ie.buffer).bytes,
        ce = oe + ie.byteOffset,
        se = re(+ae),
        de = 0;
      de < _;
...
if (!NATIVE_ARRAY_BUFFER)
  ($ArrayBuffer = function (_) {
    ...
    ($DataView = function (_, te, re) {
      anInstance(this, DataViewPrototype), anInstance(_, ArrayBufferPrototype);
      var ae = getInternalState(_).byteLength,
        ne = toIntegerOrInfinity(te);
      if (ne < 0 || ne > ae) throw RangeError$1("Wrong offset");
      if (((re = re === void 0 ? ae - ne : toLength(re)), ne + re > ae))
        throw RangeError$1(WRONG_LENGTH);
      setInternalState(this, { buffer: _, byteLength: re, byteOffset: ne }),
        DESCRIPTORS ||
          ((this.buffer = _), (this.byteLength = re), (this.byteOffset = ne));
    }),
    ...
    defineBuiltIns(DataViewPrototype, {
      ...
      getInt32: function (_) {
        return unpackInt32(
          get$2(this, 4, _, arguments.length > 1 ? arguments[1] : void 0)
        );
      },
      ...
      getFloat64: function (_) {
        return unpackIEEE754(
          get$2(this, 8, _, arguments.length > 1 ? arguments[1] : void 0),
          52
        );
      },
  ...
  if (
    ...
    ($ArrayBuffer = function (_) {
      return (
        anInstance(this, ArrayBufferPrototype),
        new NativeArrayBuffer$1(toIndex(_))
      );
    }),
...
function _unsupportedIterableToArray$6(ee, _) {
  if (!!ee) {
    ...
    if (
      te === "Arguments" ||
      /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(te)
    )
...
function _iterableToArrayLimit$5(ee, _) {
  var te =
    ee == null
      ? null
      : (typeof Symbol < "u" && ee[Symbol.iterator]) || ee["@@iterator"];
  if (te != null) {
    var re = [],
      ae = !0,
      ne = !1,
    ...
    try {
      for (
        te = te.call(ee);
        !(ae = (oe = te.next()).done) &&
        (re.push(oe.value), !(_ && re.length === _));
        ae = !0
      );
    } catch (le) {
      (ne = !0), (ie = le);
...
function _taggedTemplateLiteral$5(ee, _) {
  return (
    _ || (_ = ee.slice(0)),
    Object.freeze(
      Object.defineProperties(ee, { raw: { value: Object.freeze(_) } })
    )
  );
}
...
var StyleSheet$1 = (function () {
    function ee(te) {
      ...
      (this._insertTag = function (ae) {
        ...
        re.tags.length === 0
          ? re.insertionPoint
            ? (ne = re.insertionPoint.nextSibling)
            : re.prepend
            ? (ne = re.container.firstChild)
            : (ne = re.before)
          : (ne = re.tags[re.tags.length - 1].nextSibling),
          re.container.insertBefore(ae, ne),
          re.tags.push(ae);
      }),
    ...
    return (
      ...
      (_.insert = function (re) {
        ...
        if (this.isSpeedy) {
          var ne = sheetForTag$1(ae);
          try {
            ne.insertRule(re, ne.cssRules.length);
          } catch {}
...
function hash(ee, _) {
  return (
    (((((((_ << 2) ^ charat(ee, 0)) << 2) ^ charat(ee, 1)) << 2) ^
      charat(ee, 2)) <<
      2) ^
    charat(ee, 3)
  );
...
function delimit(ee) {
  return trim(
    slice(position - 1, delimiter(ee === 91 ? ee + 2 : ee === 40 ? ee + 1 : ee))
  );
}
...
function compile(ee) {
  return dealloc(
    parse$3("", null, null, null, [""], (ee = alloc(ee)), 0, [0], ee)
  );
}
function parse$3(ee, _, te, re, ae, ne, oe, ie, le) {
  for (
    ...
    switch (((ue = ve), (ve = next()))) {
      case 40:
        if (ue != 108 && _e.charCodeAt(de - 1) == 58) {
          indexof((_e += replace(delimit(ve), "&", "&\f")), "&\f") != -1 &&
            (ge = -1);
          break;
        }
      case 34:
        ...
        switch (ve) {
          ...
          case 59 + se:
            me > 0 &&
              ...
              append(
                me > 32
                  ? declaration(_e + ";", re, te, de - 1)
                  : declaration(replace(_e, " ", "") + ";", re, te, de - 2),
                le
              );
            break;
          case 59:
          ...
          default:
            if (
              ...
              if (se === 0) parse$3(_e, _, $e, $e, be, ne, de, ie, Se);
              else
                switch (pe) {
                  case 100:
                  case 109:
                  case 115:
                    ...
                    break;
                  default:
                    parse$3(_e, $e, $e, $e, [""], Se, 0, ie, Se);
                }
        }
        (ce = se = me = 0), (he = ge = 1), (ye = _e = ""), (de = oe);
        break;
      case 58:
        (de = 1 + strlen(_e)), (me = ue);
      default:
        if (he < 1) {
          if (ve == 123) --he;
          else if (ve == 125 && he++ == 0 && prev() == 125) continue;
        }
        switch (((_e += from(ve)), ve * he)) {
          case 38:
            ge = se > 0 ? 1 : ((_e += "\f"), -1);
            break;
          case 44:
            (ie[ce++] = (strlen(_e) - 1) * ge), (ge = 1);
            break;
          case 64:
            peek() === 45 && (_e += delimit(next())),
              (pe = peek()),
              (se = de = strlen((ye = _e += identifier(caret())))),
              ve++;
            break;
          case 45:
            ue === 45 && strlen(_e) == 2 && (he = 0);
        }
    }
  return ne;
}
function ruleset(ee, _, te, re, ae, ne, oe, ie, le, ce, se) {
  for (
    ...
    for (
      var ge = 0, ve = substr(ee, de + 1, (de = abs((he = oe[ue])))), ye = ee;
      ge < me;
      ++ge
    )
      (ye = trim(he > 0 ? pe[ge] + " " + ve : replace(ve, /&\f/g, pe[ge]))) &&
        (le[fe++] = ye);
  ...
  switch (hash(ee, _)) {
    ...
    case 5187:
      return (
        WEBKIT +
        ee +
        replace(ee, /(\w+).+(:[^]+)/, WEBKIT + "box-$1$2" + MS + "flex-$1$2") +
        ee
      );
    case 5443:
      return (
        WEBKIT + ee + MS + "flex-item-" + replace(ee, /flex-|-self/, "") + ee
      );
    case 4675:
      return (
        WEBKIT +
        ...
        MS +
        "flex-line-pack" +
        replace(ee, /align-content|flex-|-self/, "") +
        ee
      );
    case 5548:
    ...
    case 4554:
      return (
        WEBKIT + replace(ee, /([^-])(transform)/g, "$1" + WEBKIT + "$2") + ee
      );
    case 6187:
      return (
        replace(
          replace(
            replace(ee, /(zoom-|grab)/, WEBKIT + "$1"),
            /(image-set)/,
            WEBKIT + "$1"
          ),
          ee,
    ...
    case 5936:
      switch (charat(ee, _ + 11)) {
        case 114:
          return (
            WEBKIT + ee + MS + replace(ee, /[svh]\w+-[tblr]{2}/, "tb") + ee
          );
        case 108:
          return (
            WEBKIT + ee + MS + replace(ee, /[svh]\w+-[tblr]{2}/, "tb-rl") + ee
          );
        case 45:
          return (
            WEBKIT + ee + MS + replace(ee, /[svh]\w+-[tblr]{2}/, "lr") + ee
          );
      }
      return WEBKIT + ee + MS + ee + ee;
  }
...
function stringify(ee, _, te, re) {
  ...
  return strlen((te = serialize(ee.children, re)))
    ? (ee.return = ee.value + "{" + te + "}")
    : "";
}
function middleware(ee) {
  var _ = sizeof(ee);
  return function (te, re, ae, ne) {
    for (var oe = "", ie = 0; ie < _; ie++) oe += ee[ie](te, re, ae, ne) || "";
    return oe;
  };
}
...
function prefixer(ee, _, te, re) {
  if (ee.length > -1 && !ee.return)
    switch (ee.type) {
      ...
      case KEYFRAMES:
        return serialize(
          [copy(ee, { value: replace(ee.value, "@", "@" + WEBKIT) })],
          re
        );
      case RULESET:
        if (ee.length)
              ...
              case "::placeholder":
                return serialize(
                  [
                    copy(ee, {
                      props: [
                        replace(ae, /:(plac\w+)/, ":" + WEBKIT + "input-$1"),
                      ],
                    }),
                    copy(ee, {
  ...
  compat = function (_) {
    if (!(_.type !== "rule" || !_.parent || _.length < 1)) {
      for (
        var te = _.value,
          re = _.parent,
          ae = _.column === re.column && _.line === re.line;
        re.type !== "rule";
      ...
      if (
        !(
          _.props.length === 1 &&
          te.charCodeAt(0) !== 58 &&
          !fixedElements.get(re)
        ) &&
        !ae
      ) {
        fixedElements.set(_, !0);
        for (
          var ne = [], oe = getRules(te, ne), ie = re.props, le = 0, ce = 0;
          le < oe.length;
          le++
        )
          for (var se = 0; se < ie.length; se++, ce++)
            _.props[ce] = ne[le]
              ? oe[le].replace(/&\f/g, ie[se])
              : ie[se] + " " + oe[le];
      }
    }
  },
  ...
  createCache = function (_) {
    ...
    if (isBrowser$6 && te === "css") {
      ...
      Array.prototype.forEach.call(re, function (be) {
        var Se = be.getAttribute("data-emotion");
        Se.indexOf(" ") !== -1 &&
          (document.head.appendChild(be), be.setAttribute("data-s", ""));
      });
    }
    var ae = _.stylisPlugins || defaultStylisPlugins,
      ...
      ie = [];
    isBrowser$6 &&
      ((oe = _.container || document.head),
      Array.prototype.forEach.call(
        document.querySelectorAll('style[data-emotion^="' + te + ' "]'),
        function (be) {
          for (
            var Se = be.getAttribute("data-emotion").split(" "), $e = 1;
            $e < Se.length;
            $e++
          )
            ne[Se[$e]] = !0;
    ...
    if (isBrowser$6) {
      var se,
        ...
        pe = middleware(ce.concat(ae, de)),
        me = function (Se) {
          return serialize(compile(Se), pe);
        };
      le = function (Se, $e, _e, xe) {
        (se = _e),
          me(Se ? Se + "{" + $e.styles + "}" : $e.styles),
          xe && (ye.inserted[$e.name] = !0);
      };
    } else {
      var ue = [stringify],
        he = middleware(ce.concat(ae, ue)),
        fe = function (Se) {
          return serialize(compile(Se), he);
        },
        ge = getServerStylisCache(ae)(te),
        ve = function (Se, $e) {
          var _e = $e.name;
          return (
            ge[_e] === void 0 &&
              (ge[_e] = fe(Se ? Se + "{" + $e.styles + "}" : $e.styles)),
            ge[_e]
          );
        };
      le = function (Se, $e, _e, xe) {
        var Ee = $e.name,
          Te = ve(Se, $e);
        if (ye.compat === void 0) return xe && (ye.inserted[Ee] = !0), Te;
        if (xe) ye.inserted[Ee] = Te;
        else return Te;
      };
    }
    var ye = {
...
var isBrowser$5 = typeof document < "u",
  registerStyles$1 = function (_, te, re) {
  ...
  insertStyles$1 = function (_, te, re) {
    ...
    if (_.inserted[te.name] === void 0) {
      ...
      if (!isBrowser$5 && ne.length !== 0) return ne;
    }
  };
function murmur2(ee) {
...
var unitlessKeys = {
  ...
  processStyleName$1 = memoize$2(function (ee) {
    return isCustomProperty$1(ee)
      ? ee
      : ee.replace(hyphenateRegex$1, "-$&").toLowerCase();
  }),
      ...
      case "animationName":
        if (typeof te == "string")
          return te.replace(animationRegex$1, function (re, ae, ne) {
            return (cursor$1 = { name: ae, styles: ne, next: cursor$1 }), ae;
          });
    }
    return unitlessKeys[_] !== 1 &&
      !isCustomProperty$1(_) &&
      typeof te == "number" &&
      te !== 0
      ? te + "px"
      : te;
...
function handleInterpolation$1(ee, _, te) {
  ...
  switch (_typeof$1(te)) {
    ...
    case "object": {
      if (te.anim === 1)
        return (
          (cursor$1 = { name: te.name, styles: te.styles, next: cursor$1 }),
          te.name
        );
      if (te.styles !== void 0) {
        var re = te.next;
        if (re !== void 0)
          for (; re !== void 0; )
            (cursor$1 = { name: re.name, styles: re.styles, next: cursor$1 }),
              (re = re.next);
        var ae = te.styles + ";";
        return ae;
      }
  ...
  if (Array.isArray(te))
    ...
    for (var ne in te) {
      ...
      if (_typeof$1(oe) !== "object")
        _ != null && _[oe] !== void 0
          ? (re += ne + "{" + _[oe] + "}")
          : isProcessableValue$1(oe) &&
            (re +=
              processStyleName$1(ne) + ":" + processStyleValue$1(ne, oe) + ";");
      else if (
        Array.isArray(oe) &&
        typeof oe[0] == "string" &&
        (_ == null || _[oe[0]] === void 0)
      )
        for (var ie = 0; ie < oe.length; ie++)
          isProcessableValue$1(oe[ie]) &&
            (re +=
              processStyleName$1(ne) +
              ":" +
              processStyleValue$1(ne, oe[ie]) +
              ";");
      else {
...
var labelPattern$1 = /label:\s*([^\s;\n{]+)\s*(;|$)/g,
  cursor$1,
  serializeStyles$1 = function (_, te, re) {
    if (
      _.length === 1 &&
      _typeof$1(_[0]) === "object" &&
      _[0] !== null &&
      _[0].styles !== void 0
    )
      return _[0];
    ...
    cursor$1 = void 0;
    var oe = _[0];
    oe == null || oe.raw === void 0
      ? ((ae = !1), (ne += handleInterpolation$1(re, te, oe)))
      : (ne += oe[0]);
    for (var ie = 1; ie < _.length; ie++)
      (ne += handleInterpolation$1(re, te, _[ie])), ae && (ne += oe[ie]);
    labelPattern$1.lastIndex = 0;
    for (var le = "", ce; (ce = labelPattern$1.exec(ne)) !== null; )
      le += "-" + ce[1];
    var se = murmur2(ne) + le;
    return { name: se, styles: ne, next: cursor$1 };
  },
...
var StyleSheet = (function () {
  ...
  Global$1 = withEmotionCache(function (ee, _) {
    ...
    if (!isBrowser$4) {
      ...
      var le = _.compat === !0,
        ce = _.insert("", { name: ne, styles: oe }, _.sheet, le);
      return le
        ? null
        : react.exports.createElement(
            "style",
            ((ae = {}),
            (ae["data-emotion"] = _.key + "-global " + ne),
            (ae.dangerouslySetInnerHTML = { __html: ce }),
            (ae.nonce = _.sheet.nonce),
            ae)
          );
    }
    var se = react.exports.useRef();
    return (
        ...
        function () {
          var de = _.key + "-global",
            ...
            ue = document.querySelector(
              'style[data-emotion="' + de + " " + re.name + '"]'
            );
          return (
            _.sheet.tags.length && (pe.before = _.sheet.tags[0]),
            ue !== null &&
              ((me = !0),
              ue.setAttribute("data-emotion", de),
              pe.hydrate([ue])),
            (se.current = [pe, me]),
            function () {
              pe.flush();
      ...
      useInsertionEffect$1(
        function () {
          ...
          if (
            (re.next !== void 0 && insertStyles$1(_, re.next, !0),
            pe.tags.length)
          ) {
            var ue = pe.tags[pe.tags.length - 1].nextElementSibling;
            (pe.before = ue), pe.flush();
          }
          _.insert("", re, pe, !1);
        },
        [_, re.name]
...
var registerStyles = function (_, te, re) {
  ...
  insertStyles = function (_, te, re) {
    ...
    if (_.inserted[te.name] === void 0) {
      ...
      if (!isBrowser$2 && ne.length !== 0) return ne;
    }
  },
  hyphenateRegex = /[A-Z]|^ms/g,
  animationRegex = /_EMO_([^_]+?)_([^]*?)_EMO_/g,
  isCustomProperty = function (_) {
    return _.charCodeAt(1) === 45;
  },
  ...
  processStyleName = memoize$2(function (ee) {
    return isCustomProperty(ee)
      ? ee
      : ee.replace(hyphenateRegex, "-$&").toLowerCase();
  }),
      ...
      case "animationName":
        if (typeof te == "string")
          return te.replace(animationRegex, function (re, ae, ne) {
            return (cursor = { name: ae, styles: ne, next: cursor }), ae;
          });
    }
    return unitlessKeys[_] !== 1 &&
      !isCustomProperty(_) &&
...
function handleInterpolation(ee, _, te) {
  ...
  switch (_typeof$1(te)) {
    ...
    case "object": {
      if (te.anim === 1)
        return (
          (cursor = { name: te.name, styles: te.styles, next: cursor }), te.name
        );
      if (te.styles !== void 0) {
        var re = te.next;
        if (re !== void 0)
          for (; re !== void 0; )
            (cursor = { name: re.name, styles: re.styles, next: cursor }),
              (re = re.next);
        var ae = te.styles + ";";
        return ae;
      }
  ...
  if (Array.isArray(te))
    ...
    for (var ne in te) {
      ...
      if (_typeof$1(oe) !== "object")
        _ != null && _[oe] !== void 0
          ? (re += ne + "{" + _[oe] + "}")
          : isProcessableValue(oe) &&
            (re +=
              processStyleName(ne) + ":" + processStyleValue(ne, oe) + ";");
      else if (
        Array.isArray(oe) &&
        typeof oe[0] == "string" &&
        (_ == null || _[oe[0]] === void 0)
        ...
        for (var ie = 0; ie < oe.length; ie++)
          isProcessableValue(oe[ie]) &&
            (re +=
              processStyleName(ne) + ":" + processStyleValue(ne, oe[ie]) + ";");
      else {
...
var labelPattern = /label:\s*([^\s;\n{]+)\s*(;|$)/g,
  cursor,
  serializeStyles = function (_, te, re) {
    if (
      _.length === 1 &&
      _typeof$1(_[0]) === "object" &&
      _[0] !== null &&
    ...
    var oe = _[0];
    oe == null || oe.raw === void 0
      ? ((ae = !1), (ne += handleInterpolation(re, te, oe)))
      : (ne += oe[0]);
    for (var ie = 1; ie < _.length; ie++)
      (ne += handleInterpolation(re, te, _[ie])), ae && (ne += oe[ie]);
    labelPattern.lastIndex = 0;
    for (var le = "", ce; (ce = labelPattern.exec(ne)) !== null; )
      le += "-" + ce[1];
    var se = murmur2(ne) + le;
    return { name: se, styles: ne, next: cursor };
  },
  testOmitPropsOnStringTag = isPropValid,
  testOmitPropsOnComponent = function (_) {
    return _ !== "theme";
  },
...
var isBrowser$1 = typeof document < "u",
  Insertion = function (_) {
    ...
    if (!isBrowser$1 && ne !== void 0) {
      ...
      return react.exports.createElement(
        "style",
        ((oe = {}),
        (oe["data-emotion"] = te.key + " " + ie),
        (oe.dangerouslySetInnerHTML = { __html: ne }),
        (oe.nonce = te.sheet.nonce),
        oe)
      );
    }
    return null;
  ...
  createStyled = function ee(_, te) {
    ...
    var ie = composeShouldForwardProps(_, te, re),
      le = ie || getDefaultShouldForwardProp(ae),
      ce = !le("as");
    return function () {
      var se = arguments,
        de =
          re && _.__emotion_styles !== void 0
            ? _.__emotion_styles.slice(0)
            : [];
      if (
        (ne !== void 0 && de.push("label:" + ne + ";"),
        se[0] == null || se[0].raw === void 0)
      )
        de.push.apply(de, se);
      else {
        de.push(se[0][0]);
        for (var pe = se.length, me = 1; me < pe; me++)
          de.push(se[me], se[0][me]);
      }
      var ue = withEmotionCache(function (he, fe, ge) {
        var ve = (ce && he.as) || ae,
          ye = "",
          be = [],
          Se = he;
        if (he.theme == null) {
          Se = {};
          for (var $e in he) Se[$e] = he[$e];
          Se.theme = react.exports.useContext(ThemeContext);
        }
        typeof he.className == "string"
          ? (ye = getRegisteredStyles(fe.registered, be, he.className))
          : he.className != null && (ye = he.className + " ");
        var _e = serializeStyles(de.concat(be), fe.registered, Se);
        (ye += fe.key + "-" + _e.name), oe !== void 0 && (ye += " " + oe);
        var xe = ce && ie === void 0 ? getDefaultShouldForwardProp(ve) : le,
          Ee = {};
        for (var Te in he) (ce && Te === "as") || (xe(Te) && (Ee[Te] = he[Te]));
        return (
          (Ee.className = ye),
          (Ee.ref = ge),
          react.exports.createElement(
            ...
            react.exports.createElement(ve, Ee)
          )
        );
      });
      return (
        (ue.displayName =
          ne !== void 0
            ...
            : "Styled(" +
              (typeof ae == "string"
                ? ae
                : ae.displayName || ae.name || "Component") +
              ")"),
        (ue.defaultProps = _.defaultProps),
        (ue.__emotion_real = ue),
        (ue.__emotion_base = ae),
        (ue.__emotion_styles = de),
        (ue.__emotion_forwardProp = ie),
        Object.defineProperty(ue, "toString", {
          value: function () {
            return "." + oe;
          },
        }),
        (ue.withComponent = function (he, fe) {
          return ee(
            he,
            _extends$1$1({}, te, fe, {
              shouldForwardProp: composeShouldForwardProps(ue, fe, !0),
            })
          ).apply(void 0, de);
        }),
        ue
...
function _construct$1(ee, _, te) {
  return (
    _isNativeReflectConstruct$1()
      ...
      : (_construct$1 = function (ae, ne, oe) {
          var ie = [null];
          ie.push.apply(ie, ne);
          var le = Function.bind.apply(ae, ie),
            ce = new le();
...
function _wrapNativeSuper$1(ee) {
  ...
  return (
    (_wrapNativeSuper$1 = function (re) {
...
function hslToRgb$1(ee, _, te, re) {
  ...
  var ae = (((ee % 360) + 360) % 360) / 60,
    ne = (1 - Math.abs(2 * te - 1)) * _,
    oe = ne * (1 - Math.abs((ae % 2) - 1)),
    ie = 0,
    le = 0,
    ce = 0;
  ae >= 0 && ae < 1
...
function parseToRgb$1(ee) {
  ...
  if (oe) {
    var ie = parseInt("" + oe[1], 10),
      ...
      ce = parseInt("" + oe[3], 10) / 100,
      se = "rgb(" + hslToRgb$1(ie, le, ce) + ")",
      de = rgbRegex$1.exec(se);
    if (!de) throw new PolishedError$1(4, _, se);
    return {
  ...
  var pe = hslaRegex$1.exec(_.substring(0, 50));
  if (pe) {
    var me = parseInt("" + pe[1], 10),
      ue = parseInt("" + pe[2], 10) / 100,
      he = parseInt("" + pe[3], 10) / 100,
      fe = "rgb(" + hslToRgb$1(me, ue, he) + ")",
      ge = rgbRegex$1.exec(fe);
    if (!ge) throw new PolishedError$1(4, _, fe);
    return {
...
function rgbToHsl$1(ee) {
  ...
  if (ae === ne)
    return ee.alpha !== void 0
      ? { hue: 0, saturation: 0, lightness: oe, alpha: ee.alpha }
      : { hue: 0, saturation: 0, lightness: oe };
  var ie,
    le = ae - ne,
    ce = oe > 0.5 ? le / (2 - ae - ne) : le / (ae + ne);
  switch (ae) {
    case _:
  ...
  return (
    (ie *= 60),
    ee.alpha !== void 0
      ? { hue: ie, saturation: ce, lightness: oe, alpha: ee.alpha }
      : { hue: ie, saturation: ce, lightness: oe }
  );
}
...
function convertToHex$1(ee, _, te) {
  return reduceHexValue$1$1(
    "#" + colorToHex$1(ee) + colorToHex$1(_) + colorToHex$1(te)
  );
}
...
function hsla$1(ee, _, te, re) {
  ...
  if (
    ...
    return ee.alpha >= 1
      ...
      : "rgba(" +
          hslToRgb$1(ee.hue, ee.saturation, ee.lightness) +
          "," +
          ee.alpha +
          ")";
...
function rgb$1(ee, _, te) {
  if (typeof ee == "number" && typeof _ == "number" && typeof te == "number")
    return reduceHexValue$1$1(
      "#" + numberToHex$1(ee) + numberToHex$1(_) + numberToHex$1(te)
    );
  if (_typeof$1(ee) === "object" && _ === void 0 && te === void 0)
    return reduceHexValue$1$1(
      "#" +
        numberToHex$1(ee.red) +
        numberToHex$1(ee.green) +
        numberToHex$1(ee.blue)
    );
...
***************************************************************************** */ function __rest$1(
  ...
  var te = {};
  for (var re in ee)
    Object.prototype.hasOwnProperty.call(ee, re) &&
      _.indexOf(re) < 0 &&
      (te[re] = ee[re]);
  if (ee != null && typeof Object.getOwnPropertySymbols == "function")
    for (
      var ae = 0, re = Object.getOwnPropertySymbols(ee);
      ae < re.length;
      ae++
    )
      _.indexOf(re[ae]) < 0 &&
...
`,
  ...
  convertColors = function (_) {
    return Object.entries(_).reduce(function (te, re) {
      ...
      return Object.assign(
        Object.assign({}, te),
        _defineProperty$5({}, ne, mkColor(oe))
      );
    }, {});
  },
  create = function (_) {
  ...
  convert = function () {
    ...
    var re = _.colorSecondary,
      ...
      ne = _.appContentBg,
      oe = _.appBorderColor,
      ie = _.appBorderRadius,
      le = _.fontBase,
      ce = _.fontCode,
      se = _.textColor;
    _.textInverseColor;
    var de = _.barTextColor,
      pe = _.barSelectedColor,
      me = _.barBg,
      ue = _.inputBg,
      he = _.inputBorder,
      fe = _.inputTextColor,
      ge = _.inputBorderRadius,
      ve = _.brandTitle,
      ye = _.brandUrl,
      be = _.brandImage,
      Se = _.brandTarget,
    ...
    return Object.assign(Object.assign({}, _e || {}), {
      ...
      background: {
        ...
        bar: me,
        content: ne,
        gridCellSize: $e || background.gridCellSize,
      ...
      typography: {
        fonts: { base: le, mono: ce },
        weight: typography.weight,
        size: typography.size,
      },
      animation,
      easing,
      input: { border: he, background: ue, color: fe, borderRadius: ge },
      layoutMargin: 10,
      appBorderColor: oe,
      appBorderRadius: ie,
      barTextColor: de,
      barSelectedColor: pe || re,
      barBg: me,
      brand: {
        title: ve,
        url: ye,
  ...
  hasOwnProperty$d = function (_) {
    for (
      var te,
        re = arguments.length,
        ae = new Array(re > 1 ? re - 1 : 0),
        ne = 1;
      ne < re;
      ne++
    )
      ae[ne - 1] = arguments[ne];
    return (te = Object.prototype.hasOwnProperty).call.apply(
      te,
      [_].concat(ae)
    );
  },
    ...
    return ce
      ? ie.concat(
          ce.map(function (se) {
            var de, pe;
            return (pe =
              (de = se.match(/[\t ]/g)) === null || de === void 0
                ? void 0
                : de.length) !== null && pe !== void 0
              ? pe
              : 0;
          })
        )
...
function _iterableToArray$1(ee) {
  if (
    (typeof Symbol < "u" && ee[Symbol.iterator] != null) ||
    ee["@@iterator"] != null
  )
    return Array.from(ee);
}
...
var nameSpaceClassNames = function (_, te) {
  ...
  return (
    delete re.class,
    (re.className = ["sbdocs", "sbdocs-".concat(te)]
      .concat(ae)
      .filter(Boolean)
      .join(" ")),
    re
...
function parseToRgb(ee) {
  ...
  if (oe) {
    var ie = parseInt("" + oe[1], 10),
      le = parseInt("" + oe[2], 10) / 100,
      ce = parseInt("" + oe[3], 10) / 100,
      se = "rgb(" + hslToRgb(ie, le, ce) + ")",
      de = rgbRegex.exec(se);
    if (!de) throw new PolishedError(4, _, se);
    return {
      red: parseInt("" + de[1], 10),
      green: parseInt("" + de[2], 10),
      blue: parseInt("" + de[3], 10),
  ...
  var pe = hslaRegex.exec(_.substring(0, 50));
  if (pe) {
    var me = parseInt("" + pe[1], 10),
      ue = parseInt("" + pe[2], 10) / 100,
      he = parseInt("" + pe[3], 10) / 100,
      fe = "rgb(" + hslToRgb(me, ue, he) + ")",
      ge = rgbRegex.exec(fe);
    if (!ge) throw new PolishedError(4, _, fe);
    return {
      red: parseInt("" + ge[1], 10),
      green: parseInt("" + ge[2], 10),
      blue: parseInt("" + ge[3], 10),
...
function convertToHex(ee, _, te) {
  return reduceHexValue$1(
    "#" + colorToHex(ee) + colorToHex(_) + colorToHex(te)
  );
}
...
function hsla(ee, _, te, re) {
  ...
  if (
    ...
    return ee.alpha >= 1
      ...
      : "rgba(" +
          hslToRgb(ee.hue, ee.saturation, ee.lightness) +
          "," +
          ee.alpha +
          ")";
...
function rgb(ee, _, te) {
  if (typeof ee == "number" && typeof _ == "number" && typeof te == "number")
    return reduceHexValue$1(
      "#" + numberToHex(ee) + numberToHex(_) + numberToHex(te)
    );
  if (_typeof(ee) === "object" && _ === void 0 && te === void 0)
    return reduceHexValue$1(
...
function darken(ee, _) {
  ...
  return toColorString(
    _extends$1({}, te, {
      lightness: guard(0, 1, te.lightness - parseFloat(ee)),
    })
  );
}
...
function opacify(ee, _) {
  ...
  var te = parseToRgb(_),
    re = typeof te.alpha == "number" ? te.alpha : 1,
    ae = _extends$1({}, te, {
      alpha: guard(0, 1, (re * 100 + parseFloat(ee) * 100) / 100),
    });
  return rgba(ae);
}
...
var curriedTransparentize = curry(transparentize),
  ...
  Link$1 = function (_) {
    var te = _.href,
      ...
      ne = /^\//.test(te),
      oe = /^#.*/.test(te),
      ie = ne ? "?path=".concat(te) : te,
      le = oe ? "_self" : "_top";
    return React__default.createElement(
      "a",
      Object.assign({ href: ie, target: le }, ae),
      re
    );
  },
  ...
  Wrapper$8 = styled.div(withReset, function (ee) {
    ...
    return {
      backgroundColor:
        _.base === "light" ? "rgba(0,0,0,.01)" : "rgba(255,255,255,.01)",
  ...
  LazySyntaxHighlighter = react.exports.lazy(function () {
    return __vitePreload(
      () => import("./syntaxhighlighter-b07b042a.3cc618d0.js"),
      [
        "assets/syntaxhighlighter-b07b042a.3cc618d0.js",
        "assets/iframe.657ba62d.js",
        "assets/es.string.from-code-point.61b8d84d.js",
        "assets/es.regexp.flags.8811f768.js",
  ...
  LazySyntaxHighlighterWithFormatter = react.exports.lazy(function () {
    return __awaiter(
      ...
      void 0,
      void 0,
      regeneratorRuntime.mark(function ee() {
        var _, te, re, ae;
              ...
              case 0:
                return (
                  ...
                  Promise.all([
                    ...
                    __vitePreload(
                      () => import("./formatter-0d5cb0eb.243bec5d.js"),
                      [
                        "assets/formatter-0d5cb0eb.243bec5d.js",
                        "assets/iframe.657ba62d.js",
                        "assets/es.map.constructor.3fc5bb37.js",
                        "assets/string.dd967029.js",
                        "assets/es.string.from-code-point.61b8d84d.js",
...
var SourceSkeletonWrapper = styled.div(function (ee) {
  ...
  Source$1 = function (_) {
    ...
    var ae = _,
      ...
      ie = ae.dark,
      le = ae.format,
      ce = __rest(ae, ["language", "code", "dark", "format"]),
...
var isReactChildString = function (_) {
  ...
  Code = function (_) {
    var te,
      re = _.className,
      ae = _.children,
      ne = __rest(_, ["className", "children"]),
      oe = (re || "").match(/lang-(\S+)/),
      ie = react.exports.Children.toArray(ae),
      le = !ie.filter(isReactChildString).some(function (ce) {
        return ce.match(isInlineCodeRegex);
      });
    return le
      ? React__default.createElement(
          DefaultCodeBlock,
          Object.assign({}, ne, { className: re }),
          ie
        )
      : React__default.createElement(
          StyledSyntaxHighlighter,
          Object.assign(
            {
              ...
              copyable: !0,
              language:
                (te = oe == null ? void 0 : oe[1]) !== null && te !== void 0
                  ? te
                  : "plaintext",
              format: !1,
            },
  ...
  components$1 = {
    h1: function (_) {
      return React__default.createElement(
        H1,
        Object.assign({}, nameSpaceClassNames(_, "h1"))
      );
    },
    h2: function (_) {
      return React__default.createElement(
        H2,
        Object.assign({}, nameSpaceClassNames(_, "h2"))
      );
    },
    h3: function (_) {
      return React__default.createElement(
        H3,
        Object.assign({}, nameSpaceClassNames(_, "h3"))
      );
    },
    h4: function (_) {
      return React__default.createElement(
        H4,
        Object.assign({}, nameSpaceClassNames(_, "h4"))
      );
    },
    h5: function (_) {
      return React__default.createElement(
        H5,
        Object.assign({}, nameSpaceClassNames(_, "h5"))
      );
    },
    h6: function (_) {
      return React__default.createElement(
        H6,
        Object.assign({}, nameSpaceClassNames(_, "h6"))
      );
    },
    pre: function (_) {
      return React__default.createElement(
        Pre,
        Object.assign({}, nameSpaceClassNames(_, "pre"))
      );
    },
    a: function (_) {
      return React__default.createElement(
        A$2,
        Object.assign({}, nameSpaceClassNames(_, "a"))
      );
    },
    hr: function (_) {
      return React__default.createElement(
        HR,
        Object.assign({}, nameSpaceClassNames(_, "hr"))
      );
    },
    dl: function (_) {
      return React__default.createElement(
        DL,
        Object.assign({}, nameSpaceClassNames(_, "dl"))
      );
    },
    ...
    img: function (_) {
      return React__default.createElement(
        Img,
        Object.assign({}, nameSpaceClassNames(_, "img"))
      );
    },
    div: function (_) {
      return React__default.createElement(
        Div,
        Object.assign({}, nameSpaceClassNames(_, "div"))
      );
    },
    span: function (_) {
      return React__default.createElement(
        Span,
        Object.assign({}, nameSpaceClassNames(_, "span"))
      );
    },
    li: function (_) {
      return React__default.createElement(
        LI,
        Object.assign({}, nameSpaceClassNames(_, "li"))
      );
    },
    ul: function (_) {
      return React__default.createElement(
        UL,
        Object.assign({}, nameSpaceClassNames(_, "ul"))
      );
    },
    ol: function (_) {
      return React__default.createElement(
        OL,
        Object.assign({}, nameSpaceClassNames(_, "ol"))
      );
    },
    p: function (_) {
      return React__default.createElement(
        P$1,
        Object.assign({}, nameSpaceClassNames(_, "p"))
      );
    },
    code: function (_) {
      return React__default.createElement(
        Code,
        Object.assign({}, nameSpaceClassNames(_, "code"))
      );
    },
    tt: function (_) {
      return React__default.createElement(
        TT,
        Object.assign({}, nameSpaceClassNames(_, "tt"))
      );
    },
...
var LEFT_BUTTON = 0,
  isPlainLeftClick = function (_) {
    return (
      _.button === LEFT_BUTTON &&
      !_.altKey &&
      !_.ctrlKey &&
      !_.metaKey &&
      !_.shiftKey
    ...
    function (ee) {
      ...
      return te
        ? {
            ...
            "&:hover": {
              color: _.color.lighter,
              "svg path": { fill: _.color.lighter },
            },
            "&:active": {
              color: _.color.light,
              "svg path": { fill: _.color.light },
            },
          }
        : {};
    },
  ...
  ActionButton = styled.button(
    function (ee) {
      ...
      return {
        ...
        "&:not(:last-child)": {
          borderRight: "1px solid ".concat(_.appBorderColor),
        },
        "& + *": {
          borderLeft: "1px solid ".concat(_.appBorderColor),
          borderRadius: 0,
...
var ActionBar = function (_) {
  ...
  return React__default.createElement(
    ...
    te.map(function (ae, ne) {
      ...
      return React__default.createElement(
        ActionButton,
        { key: ne, className: ie, onClick: le, disabled: ce },
        oe
      );
    })
  );
  ...
  function (ee) {
    ...
    switch (!0) {
      case !!(te && re):
        return {
          marginLeft: te * _.layoutMargin,
          marginRight: te * _.layoutMargin,
        };
      case !!(te && ae):
        return {
          marginTop: te * _.layoutMargin,
          marginBottom: te * _.layoutMargin,
        };
      default:
        return {};
    }
...
var Title$3 = styled.div(function (ee) {
  ...
  GlobalScrollAreaStyles = react.exports.lazy(function () {
    return __vitePreload(
      () => import("./GlobalScrollAreaStyles-8793ce4a.e58fac50.js"),
      [
        "assets/GlobalScrollAreaStyles-8793ce4a.e58fac50.js",
        "assets/iframe.657ba62d.js",
        "assets/jsx-runtime.9dff8acf.js",
        "assets/string.dd967029.js",
        "assets/es.map.constructor.3fc5bb37.js",
  ...
  OverlayScrollbars = react.exports.lazy(function () {
    return __vitePreload(
      () => import("./OverlayScrollbars-1355f44c.0bc4732f.js"),
      [
        "assets/OverlayScrollbars-1355f44c.0bc4732f.js",
        "assets/iframe.657ba62d.js",
        "assets/es.number.to-fixed.04f7b86b.js",
        "assets/jsx-runtime.9dff8acf.js",
        "assets/string.dd967029.js",
...
function getDefaultExportFromCjs(ee) {
  return ee &&
    ee.__esModule &&
    Object.prototype.hasOwnProperty.call(ee, "default")
    ? ee.default
    : ee;
}
var win;
...
function ZoomElement(ee) {
  ...
  return (
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        "div",
        { ref: re, className: "innerZoomElementWrapper" },
        te
      )
    )
  );
        ...
        },
        {
          ...
          value: function (ae) {
            var ne = this.props,
              ...
              ie = ne.active;
            return (
              oe !== ae.scale && this.setIframeInnerZoom(ae.scale),
              ie !== ae.active &&
                this.iframe.setAttribute(
                  "data-is-storybook",
                  ae.active ? "true" : "false"
                ),
  ...
  ButtonWrapper = styled.button(
    function (ee) {
      ...
      return {
        ...
        background: "transparent",
        fontSize: "".concat(
          _ ? te.typography.size.s1 : te.typography.size.s2 - 1,
          "px"
        ),
    ...
    function (ee) {
      ...
      return (
        ae
          ? (ne = _.color.medium)
          : re
          ? (ne = _.color.secondary)
          : te && (ne = _.color.primary),
        ne
          ? {
              background: ne,
              ...
              "&:focus": {
                boxShadow: "".concat(rgba(ne, 1), " 0 1px 9px 2px"),
                outline: "none",
              },
              "&:focus:hover": {
                boxShadow: "".concat(rgba(ne, 0.2), " 0 8px 18px 0px"),
              },
            }
          : {}
      );
    ...
    function (ee) {
      var _ = ee.theme,
        ...
        ne;
      return (
        ae ? (ne = _.color.secondary) : re && (ne = _.color.primary),
        te && ne
          ? {
...
var noop$2 = function () {},
  ...
  getSizingData = function (_) {
    ...
    isIE &&
      ...
      (re.width =
        ...
        "px");
    var ne = parseFloat(re.paddingBottom) + parseFloat(re.paddingTop),
      oe = parseFloat(re.borderBottomWidth) + parseFloat(re.borderTopWidth);
  ...
  TextareaAutosize = function (_, te) {
    var re = _.cacheMeasurements,
      ...
      le = _.onHeightChange,
      ce = le === void 0 ? noop$2 : le,
      se = _objectWithoutPropertiesLoose$2(_, [
        "cacheMeasurements",
        "maxRows",
        "minRows",
        "onChange",
      ...
      de = se.value !== void 0,
      pe = react.exports.useRef(null),
      me = useComposedRef(pe, te),
      ue = react.exports.useRef(0),
      he = react.exports.useRef(),
      fe = function () {
        var ye = pe.current,
          be = re && he.current ? he.current : getSizingData(ye);
        if (!!be) {
          he.current = be;
          var Se = calculateNodeHeight(
              be,
              ye.value || ye.placeholder || "x",
              ne,
              ae
            ),
            $e = Se[0],
          ...
          ue.current !== $e &&
            ((ue.current = $e),
            ye.style.setProperty("height", $e + "px", "important"),
            ce($e, { rowHeight: _e }));
        }
      },
      ge = function (ye) {
    ...
    return (
      typeof document < "u" &&
        (react.exports.useLayoutEffect(fe), useWindowResizeListener(fe)),
      react.exports.createElement(
        "textarea",
        _extends({}, se, { onChange: ge, ref: me })
      )
    );
  },
  ...
  styles = function (_) {
    ...
    return Object.assign(Object.assign({}, styleResets$1), {
      ...
      padding: "6px 10px",
      "&:focus": {
        boxShadow: "".concat(te.color.secondary, " 0 0 0 1px inset"),
        outline: "none",
      },
      "&[disabled]": { cursor: "not-allowed", opacity: 0.5 },
      "&:-webkit-autofill": {
        WebkitBoxShadow: "0 0 0 3em ".concat(te.color.lightest, " inset"),
      },
  ...
  LazyWithTooltip = react.exports.lazy(function () {
    return __vitePreload(
      () => import("./WithTooltip-167e9982.c9ed3323.js"),
      [
        "assets/WithTooltip-167e9982.c9ed3323.js",
        "assets/iframe.657ba62d.js",
        "assets/es.map.constructor.3fc5bb37.js",
        "assets/es.regexp.flags.8811f768.js",
        "assets/jsx-runtime.9dff8acf.js",
        "assets/index.b039751f.js",
        "assets/string.dd967029.js",
        "assets/es.number.to-fixed.04f7b86b.js",
      ]
    ).then(function (ee) {
...
var Note = styled.div(function (ee) {
    ...
    return {
      ...
      zIndex: -1,
      background:
        _.base === "light" ? "rgba(60, 60, 60, 0.9)" : "rgba(20, 20, 20, 0.85)",
      margin: 6,
    };
  }),
  ...
  Title$1 = styled(function (ee) {
    ...
    function (ee) {
      var _ = ee.active,
        te = ee.theme;
      return _
        ? { color: te.color.primary, fontWeight: te.typography.weight.bold }
        : {};
    },
    function (ee) {
      var _ = ee.loading,
    ...
    function (ee) {
      var _ = ee.disabled,
        te = ee.theme;
      return _
        ? { color: curriedTransparentize$1(0.7, te.color.defaultText) }
        : {};
    }
  ),
  Right = styled.span(
    ...
    function (ee) {
      var _ = ee.active,
        te = ee.theme;
      return _
        ? { "& svg": { opacity: 1 }, "& path": { fill: te.color.primary } }
        : {};
    }
  ),
  Center = styled.span({
  ...
  ListItem = function (_) {
    var te = _.loading,
      ...
      me = getItemProps(se, ce, de),
      ue = { active: ie, disabled: le };
    return React__default.createElement(
      Item$3,
      Object.assign({}, ue, pe, me),
      re && React__default.createElement(Left, Object.assign({}, ue), re),
      ae || ne
        ? React__default.createElement(
            Center,
            null,
        ...
        : null,
      oe && React__default.createElement(Right, Object.assign({}, ue), oe)
    );
  };
...
var BarInner = styled.div(function (ee) {
  ...
  FlexBar = function (_) {
    var te = _.children,
      ...
      ne = react.exports.Children.toArray(te),
...
var top = "top",
  ...
  TabButton = styled(ButtonOrLink, { shouldForwardProp: isPropValid })(
    ...
    function (ee) {
      ...
      return _
        ? {
            color: te || re.barSelectedColor,
            borderBottomColor: re.barSelectedColor,
          }
...
var IconButton = styled(ButtonOrLink, { shouldForwardProp: isPropValid })(
  ...
  function (ee) {
    var _ = ee.active,
      te = ee.theme;
    return _
      ? { backgroundColor: te.background.hoverable, color: te.color.secondary }
      : {};
  },
  function (ee) {
    var _ = ee.disabled,
...
var IconPlaceholder = styled.div(function (ee) {
  ...
  childrenToList = function (_, te) {
    return react.exports.Children.toArray(_).map(function (re, ae) {
      var ne = re.props,
        ...
        le = ne.color,
        ce = ne.children,
        se = Array.isArray(ce) ? ce[0] : ce;
      return {
        active: te ? ie === te : ae === 0,
        title: oe,
        id: ie,
        color: le,
        render:
          typeof se == "function"
            ...
            : function (de) {
                ...
                return React__default.createElement(
                  VisuallyHidden,
                  { key: me, active: pe, role: "tabpanel" },
                  se
                );
              },
      };
  ...
  Tabs = react.exports.memo(function (ee) {
    var _ = ee.children,
      ...
      ne = ee.bordered,
      oe = ee.tools,
      ie = ee.backgroundColor,
      le = ee.id,
      ce = childrenToList(_, te);
    return ce.length
      ? React__default.createElement(
          Wrapper$6,
          { absolute: ae, bordered: ne, id: le },
          React__default.createElement(
            FlexBar,
            ...
            React__default.createElement(
              ...
              ce.map(function (se) {
                var de = se.title,
                  ...
                  me = se.active,
                  ue = se.color,
                  he = typeof de == "function" ? de() : de;
                return React__default.createElement(
                  TabButton,
                  {
                    id: "tabbutton-".concat(dist.sanitize(he)),
                    ...
                    textColor: ue,
                    onClick: function (ge) {
                      ge.preventDefault(), re.onSelect(pe);
                    },
                    role: "tab",
                  },
                  he
            ...
            oe
              ? React__default.createElement(react.exports.Fragment, null, oe)
              : null
          ),
          React__default.createElement(
            Content,
            { id: "panel-tab-content", bordered: ne, absolute: ae },
            ce.map(function (se) {
              var de = se.id,
                pe = se.active,
                me = se.render;
              return me({ key: de, active: pe });
            })
          )
        )
      : React__default.createElement(
    ...
    _createClass(te, [
      {
        ...
        value: function () {
          var ae = this.props,
            ...
            le = ie === void 0 ? !1 : ie,
            ce = ae.children,
            se = ae.backgroundColor,
            de = this.state.selected;
          return React__default.createElement(
            Tabs,
            {
              bordered: oe,
...
function pt(ee, _, te) {
  ...
  var ne = [[]];
  return (
    ae.forEach(function (oe, ie) {
      oe.type === "tableSeparator"
        ? ie !== 0 && ie !== ae.length - 1 && ne.push([])
        : (oe.type !== "text" ||
            (ae[ie + 1] != null && ae[ie + 1].type !== "tableSeparator") ||
...
function Mt(ee, _, te) {
  for (
    var re = ee, ae = _.split(".");
    ae.length && ((re = re[ae[0]]), re !== void 0);
...
function Bt(ee) {
  ...
  (_.overrides = _.overrides || {}),
    ...
    (_.namedCodesToUnicode = _.namedCodesToUnicode
      ? e({}, c, _.namedCodesToUnicode)
      : c);
  var te = _.createElement || React__default.createElement;
  function re(me, ue) {
    for (
      var he = Mt(_.overrides, "".concat(me, ".props"), {}),
        fe = arguments.length,
        ge = new Array(fe > 2 ? fe - 2 : 0),
        ve = 2;
      ve < fe;
      ve++
    )
    ...
    return te.apply(
      ...
      [
        (function (ye, be) {
          ...
          return Se
            ? typeof Se == "function" ||
              (_typeof(Se) == "object" && "render" in Se)
              ? Se
              : Mt(be, "".concat(ye, ".component"), ye)
            : ye;
        })(me, _.overrides),
        e({}, ue, he, {
          className:
            It(ue == null ? void 0 : ue.className, he.className) || void 0,
        }),
      ].concat(ge)
    );
  }
  function ae(me) {
    var ue = !1;
    _.forceInline ? (ue = !0) : _.forceBlock || (ue = P.test(me) === !1);
    for (
      var he = se(
        ce(
          ue
...
`
      ...
      typeof he[he.length - 1] == "string" && !he[he.length - 1].trim();

    )
      he.pop();
    if (_.wrapper === null) return he;
    var fe = _.wrapper || (ue ? "span" : "div"),
      ge;
    if (he.length > 1 || _.forceWrapper) ge = he;
    else {
      if (he.length === 1)
        return (
          (ge = he[0]),
          typeof ge == "string" ? re("span", { key: "outer" }, ge) : ge
        );
      ge = null;
    }
    return React__default.createElement(fe, { key: "outer" }, ge);
  }
  function ne(me) {
    var ue = me.match(u);
    return ue
      ? ue.reduce(function (he, fe, ge) {
          var ve = fe.indexOf("=");
          if (ve !== -1) {
            var ye = (function (_e) {
                return (
                  _e.indexOf("-") !== -1 &&
                    _e.match(A$3) === null &&
                    (_e = _e.replace(j, function (xe, Ee) {
              ...
              be = (function (_e) {
                return _e
                  ? (n.test(_e.charAt(0)) && (_e = _e.substr(1)),
                    n.test(_e.charAt(_e.length - 1)) &&
                      (_e = _e.substr(0, _e.length - 1)),
                    _e)
                  : "";
              })(fe.slice(ve + 1).trim()),
              Se = o[ye] || ye,
              $e = (he[Se] = (function (_e, xe) {
                return _e === "style"
                  ? xe.split(/;\s?/).reduce(function (Ee, Te) {
                      var Ce = Te.slice(0, Te.indexOf(":"));
                      return (
                        (Ee[
                          Ce.replace(/(-[a-z])/g, function (Ae) {
                            return Ae[1].toUpperCase();
                          })
                        ] = Te.slice(Ce.length + 1).trim()),
                        Ee
                      );
                    }, {})
                  : _e === "href"
                  ? bt(xe)
                  : (xe.match(I) && (xe = xe.slice(1, xe.length - 1)),
                    xe === "true" || (xe !== "false" && xe));
              })(ye, be));
            typeof $e == "string" &&
              (w.test($e) || R.test($e)) &&
              (he[Se] = React__default.cloneElement(ae($e.trim()), {
                key: ge,
              }));
          } else fe !== "style" && (he[o[fe] || fe] = !0);
          return he;
        }, {})
      : void 0;
  }
  var oe = [],
    ...
    le = {
      blockQuote: {
        ...
        l: Ot.HIGH,
        _: function (ue, he, fe) {
          return { content: he(ue[0].replace(_2, ""), fe) };
        },
        p: function (ue, he, fe) {
          return re("blockquote", { key: fe.g }, he(ue.content, fe));
        },
      },
      breakLine: {
        i: xt(f),
      ...
      codeBlock: {
        ...
        _: function (ue) {
          return {
            content: ue[0].replace(/^ {4}/gm, "").replace(/\n+$/, ""),
            lang: void 0,
          };
        },
        p: function (ue, he, fe) {
          return re(
            ...
            re(
              "code",
              { className: ue.lang ? "lang-".concat(ue.lang) : "" },
              ue.content
            )
          );
        },
      ...
      codeInline: {
        ...
        p: function (ue, he, fe) {
          return re("code", { key: fe.g }, ue.content);
        },
      },
      footnote: {
        i: kt(k),
      ...
      footnoteReference: {
        ...
        p: function (ue, he, fe) {
          return re(
            "a",
            { key: fe.g, href: bt(ue.target) },
            re("sup", { key: fe.g }, ue.content)
          );
        },
      },
      gfmTask: {
      ...
      heading: {
        ...
        p: function (ue, he, fe) {
          return (
            (ue.tag = "h".concat(ue.level)),
            re(ue.tag, { id: ue.id, key: fe.g }, he(ue.content, fe))
          );
        },
      },
      headingSetext: {
      ...
      link: {
        ...
        p: function (ue, he, fe) {
          return re(
            "a",
            { key: fe.g, href: bt(ue.target), title: ue.title },
            he(ue.content, fe)
          );
        },
      },
      linkAngleBraceStyleDetector: {
        ...
        _: function (ue) {
          return {
            content: [{ content: ue[1], type: "text" }],
            target: ue[1],
            type: "link",
          };
        },
      ...
      linkMailtoDetector: {
        ...
        _: function (ue) {
          var he = ue[1],
            fe = ue[1];
          return (
            i.test(fe) || (fe = "mailto:" + fe),
            {
              content: [{ content: he.replace("mailto:", ""), type: "text" }],
              target: fe,
              type: "link",
            }
          );
      ...
      list: {
        i: function (ue, he, fe) {
          var ge = T.exec(fe);
          return !ge || (!he.h && he.o) ? null : at.exec((ue = ge[1] + ue));
        },
        l: Ot.HIGH,
        _: function (ue, he, fe) {
          var ge = ue[2],
...
`
            ...
            Se = !1;
          return {
            items: be.map(function ($e, _e) {
              var xe = ot.exec($e)[0].length,
                Ee = new RegExp("^ {1," + xe + "}", "gm"),
                Te = $e.replace(Ee, "").replace(ot, ""),
                Ce = _e === be.length - 1,
                Ae =
                  Te.indexOf(`
...
`
                  ...
                  : ((fe.o = !0), (Oe = Te.replace(L, "")));
              var Le = he(Oe, fe);
              return (fe.o = Re), (fe.h = we), Le;
            }),
            ordered: ve,
            start: ye,
          };
        ...
        p: function (ue, he, fe) {
          return re(
            ue.ordered ? "ol" : "ul",
            { key: fe.g, start: ue.start },
            ue.items.map(function (ge, ve) {
              return re("li", { key: ve }, he(ge, fe));
            })
          );
        },
      },
...
`;
      ...
      paragraph: {
        ...
        _: Et,
        p: function (ue, he, fe) {
          return re("p", { key: fe.g }, he(ue.content, fe));
        },
      },
      ref: {
        i: yt(D),
      ...
      refImage: {
        ...
        p: function (ue, he, fe) {
          return re("img", {
            key: fe.g,
            alt: ue.alt,
            src: bt(ie[ue.ref].target),
            title: ie[ue.ref].title,
          });
        },
      },
      refLink: {
        ...
        _: function (ue, he, fe) {
          return {
            content: he(ue[1], fe),
            fallbackContent: he(ue[0].replace(F, "\\$1"), fe),
            ref: ue[2],
          };
        },
        p: function (ue, he, fe) {
          return ie[ue.ref]
            ? re(
                ...
                {
                  key: fe.g,
                  href: bt(ie[ue.ref].target),
                  title: ie[ue.ref].title,
                },
                he(ue.content, fe)
              )
            : re("span", { key: fe.g }, he(ue.fallbackContent, fe));
        },
      },
      table: {
        i: kt(C),
          ...
          return re(
            ...
            re(
              ...
              re(
                "tr",
                null,
                ue.header.map(function (ge, ve) {
                  return re("th", { key: ve, style: mt(ue, ve) }, he(ge, fe));
                })
              )
            ),
            re(
              "tbody",
              null,
              ue.cells.map(function (ge, ve) {
                return re(
                  "tr",
                  { key: ve },
                  ge.map(function (ye, be) {
                    return re("td", { key: be, style: mt(ue, be) }, he(ye, fe));
                  })
                );
              })
            )
      ...
      text: {
        ...
        _: function (ue) {
          return {
            content: ue[0].replace(z, function (he, fe) {
              return _.namedCodesToUnicode[fe] ? _.namedCodesToUnicode[fe] : he;
            }),
          };
        },
        p: function (ue) {
      ...
      textBolded: {
        ...
        l: Ot.MED,
        _: function (ue, he, fe) {
          return { content: he(ue[2], fe) };
        },
        p: function (ue, he, fe) {
          return re("strong", { key: fe.g }, he(ue.content, fe));
        },
      },
      textEmphasized: {
        i: ht(J),
        ...
        p: function (ue, he, fe) {
          return re("em", { key: fe.g }, he(ue.content, fe));
        },
      },
      textEscaped: {
        i: ht(Y),
      ...
      textStrikethroughed: {
        ...
        _: Et,
        p: function (ue, he, fe) {
          return re("del", { key: fe.g }, he(ue.content, fe));
        },
      },
    };
  _.disableParsingRawHTML !== !0 &&
    ((le.htmlBlock = {
      ...
      l: Ot.HIGH,
      _: function (ue, he, fe) {
        var ge = ue[3].match(nt),
          ve = _slicedToArray$4(ge, 2),
          ye = ve[1],
          be = new RegExp("^".concat(ye), "gm"),
          Se = ue[3].replace(be, ""),
          $e =
            ((_e = Se),
            _t.some(function (Ce) {
      ...
      p: function (ue, he, fe) {
        return re(
          ue.tag,
          e({ key: fe.g }, ue.attrs),
          ue.noInnerParse ? ue.content : he(ue.content, fe)
        );
      },
    }),
    (le.htmlSelfClosing = {
      ...
      p: function (ue, he, fe) {
        return re(ue.tag, e({}, ue.attrs, { key: fe.g }));
      },
    }));
  var ce = (function (me) {
      var ue = Object.keys(me);
      function he(fe, ge) {
        for (var ve = [], ye = ""; fe; )
          for (var be = 0; be < ue.length; ) {
            ...
            if (_e) {
              var xe = _e[0];
              fe = fe.substring(xe.length);
              var Ee = $e._(_e, he, ge);
              Ee.type == null && (Ee.type = Se), ve.push(Ee), (ye = xe);
              break;
            }
            be++;
          }
      ...
      return (
        ue.sort(function (fe, ge) {
          var ve = me[fe].l,
            ye = me[ge].l;
          return ve !== ye ? ve - ye : fe < ge ? -1 : 1;
        }),
        function (fe, ge) {
          return he(
            (function (ve) {
...
`
    ...
    se =
      ((de = (function (me) {
        return function (ue, he, fe) {
          return me[ue.type].p(ue, he, fe);
        };
      })(le)),
      function me(ue) {
        var he =
        ...
        if (Array.isArray(ue)) {
          for (var fe = he.g, ge = [], ve = !1, ye = 0; ye < ue.length; ye++) {
            he.g = ye;
            var be = me(ue[ye], he),
              Se = typeof be == "string";
            Se && ve ? (ge[ge.length - 1] += be) : be !== null && ge.push(be),
              (ve = Se);
          }
          return (he.g = fe), ge;
        }
    ...
    ? re(
        ...
        re(
          ...
          oe.map(function (me) {
            return re(
              "div",
              { id: _.slugify(me.identifier), key: me.identifier },
              me.identifier,
              se(ce(me.footnote, { o: !0 }))
            );
          })
        )
      )
...
var Markdown = function (_) {
  ...
  getStoryHref = function (_, te) {
    var re =
      ...
      ie = ne[1],
      le = ie
        ? Object.assign(Object.assign(Object.assign({}, lib.parse(ie)), re), {
            id: te,
          })
        : Object.assign(Object.assign({}, re), { id: te });
    return ""
      .concat(oe)
      .concat(lib.stringify(le, { addQueryPrefix: !0, encode: !1 }));
  },
  Zoom = function (_) {
    var te = _.zoom,
      re = _.resetZoom;
  ...
  Toolbar = function (_) {
    var te = _.isLoading,
      ...
      ne = _.zoom,
      oe = _.resetZoom,
      ie = __rest(_, ["isLoading", "storyId", "baseUrl", "zoom", "resetZoom"]);
    return React__default.createElement(
      Bar,
      Object.assign({}, ie),
      React__default.createElement(
        ...
        te
          ...
          : React__default.createElement(
              Zoom,
              Object.assign({}, { zoom: ne, resetZoom: oe })
            )
      ),
      React__default.createElement(
        react.exports.Fragment,
        ...
        re &&
          (te
            ...
            : React__default.createElement(
                Eject,
                Object.assign({}, { storyId: re, baseUrl: ae })
              ))
      )
    );
  },
...
`,
  ...
  PureLoader = function (_) {
    var te = _.progress,
      re = _.error,
      ae = _.size,
      ne = __rest(_, ["progress", "error", "size"]);
    if (re)
      return React__default.createElement(
        ProgressWrapper,
        Object.assign(
          {
            "aria-label": re.toString(),
            "aria-live": "polite",
            role: "status",
          },
          ne
    ...
    if (te) {
      ...
      return (
        ie &&
          (le += " ".concat(ie.complete, " / ").concat(ie.total, " modules")),
        React__default.createElement(
          ProgressWrapper,
          Object.assign(
            {
  ...
  Loader = function (_) {
    var te = react.exports.useState(void 0),
      ...
      ae = re[0],
      ne = re[1],
      oe = react.exports.useState(void 0),
    ...
    return (
      react.exports.useEffect(function () {
        if (!(CONFIG_TYPE !== "DEVELOPMENT" || !EventSource)) {
          var se = new EventSource("/progress"),
            de;
          return (
            (se.onmessage = function (pe) {
              try {
                (de = JSON.parse(pe.data)), ne(de);
              } catch (me) {
                ce(me), se.close();
              }
            }),
            (se.onerror = function () {
              de && de.value !== 1 && ce(new Error("Connection closed")),
                se.close();
            }),
            function () {
              return se.close();
      ...
      React__default.createElement(
        PureLoader,
        Object.assign({ progress: ae, error: le }, _)
      )
    );
  },
  ...
  ChildrenContainer = styled.div(
    function (ee) {
      ...
      return {
        ...
        "& .innerZoomElementWrapper > *": _
          ? {
              width: re !== "fullscreen" ? "calc(100% - 20px)" : "100%",
              display: "block",
            }
          : {
    ...
    function (ee) {
      ...
      return _ && _ > 1
        ? {
            ".innerZoomElementWrapper > *": {
              minWidth: "calc(100% / ".concat(_, " - 20px)"),
            },
          }
        : {};
    }
  ...
  StyledSource = styled(Source$1)(function (ee) {
    ...
    return {
      ...
      background:
        _.base === "light"
          ? "rgba(0, 0, 0, 0.85)"
          : curriedDarken$1(0.05, _.background.content),
      color: _.color.lightest,
      button: {
        background:
          _.base === "light"
...
var PositionedToolbar = styled(Toolbar)({
    ...
    return _.reduce(function (te, re) {
      return (
        ...
        (typeof re == "string" || typeof re == "number"
          ? "padded"
          : (re.props && re.props.parameters && re.props.parameters.layout) ||
            "padded")
      );
    }, void 0);
  },
  Preview$1 = function (_) {
    var te = _.isLoading,
      ...
      ue = react.exports.useState(se),
      he = _slicedToArray$4(ue, 2),
      fe = he[0],
      ge = he[1],
      ve = getSource(oe, fe, ge),
      ye = ve.source,
      be = ve.actionItem,
      Se = react.exports.useState(1),
      $e = _slicedToArray$4(Se, 2),
      _e = $e[0],
      xe = $e[1],
      Ee = [pe].concat(["sbdocs", "sbdocs-preview"]),
      Te = oe ? [be] : [],
      Ce = react.exports.useState(de ? _toConsumableArray$1(de) : []),
      Ae = _slicedToArray$4(Ce, 2),
      Re = Ae[0],
      we = Ae[1],
      Oe = [].concat(Te, _toConsumableArray$1(Re)),
      Le = getLayout(react.exports.Children.count(ne) === 1 ? [ne] : ne),
      Ne = window_1.window,
      je = react.exports.useCallback(function (Me) {
        return __awaiter(
          void 0,
          void 0,
          void 0,
          regeneratorRuntime.mark(function Ie() {
            var ke, Be;
            return regeneratorRuntime.wrap(function (Pe) {
              for (;;)
                switch ((Pe.prev = Pe.next)) {
                  ...
                  case 2:
                    (ke = Pe.sent),
                      (Be = ke.createCopyToClipboardFunction),
                      Be();
                  case 5:
                  case "end":
                    return Pe.stop();
      ...
      Fe = function (Ie) {
        Ie.preventDefault(),
          Re.filter(function (ke) {
            return ke.title === "Copied";
          }).length === 0 &&
            je(ye.props.code).then(function () {
              we(
                [].concat(_toConsumableArray$1(Re), [
    ...
    return React__default.createElement(
      PreviewContainer,
      Object.assign({}, { withSource: oe, withToolbar: le }, me, {
        className: Ee.join(" "),
      }),
      le &&
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          Relative,
          { className: "docs-story", onCopyCapture: oe && Fe },
          React__default.createElement(
            ChildrenContainer,
            { isColumn: re || !Array.isArray(ne), columns: ae, layout: Le },
            React__default.createElement(
              Zoom$1.Element,
              { scale: _e },
              Array.isArray(ne)
                ? ne.map(function (Me, Ie) {
                    return React__default.createElement("div", { key: Ie }, Me);
                  })
                : React__default.createElement("div", null, ne)
            )
          ),
          React__default.createElement(ActionBar, { actionItems: Oe })
        )
      ),
      oe && fe && ye
    );
...
function arrayMap$2(ee, _) {
  for (
    var te = -1, re = ee == null ? 0 : ee.length, ae = Array(re);
    ++te < re;
...
function getRawTag$1(ee) {
  ...
  return (
    re && (_ ? (ee[symToStringTag$1] = te) : delete ee[symToStringTag$1]), ae
  );
}
...
function equalArrays$2(ee, _, te, re, ae, ne) {
  var oe = te & COMPARE_PARTIAL_FLAG$5,
    ie = ee.length,
    le = _.length;
  if (ie != le && !(oe && le > ie)) return !1;
  var ce = ne.get(ee),
    se = ne.get(_);
  if (ce && se) return ce == _ && se == ee;
  var de = -1,
    pe = !0,
    me = te & COMPARE_UNORDERED_FLAG$3 ? new SetCache$1() : void 0;
  for (ne.set(ee, _), ne.set(_, ee); ++de < ie; ) {
    var ue = ee[de],
      he = _[de];
    if (re) var fe = oe ? re(he, ue, de, _, ee, ne) : re(ue, he, de, ee, _, ne);
    if (fe !== void 0) {
      if (fe) continue;
      pe = !1;
      break;
    ...
    if (me) {
      if (
        !arraySome(_, function (ge, ve) {
          if (!cacheHas$1(me, ve) && (ue === ge || ae(ue, ge, te, re, ne)))
            return me.push(ve);
        })
      ) {
        pe = !1;
    ...
    } else if (!(ue === he || ae(ue, he, te, re, ne))) {
      pe = !1;
      break;
    }
  }
  return ne.delete(ee), ne.delete(_), pe;
}
...
function equalByTag$1(ee, _, te, re, ae, ne, oe) {
  switch (te) {
    ...
    case arrayBufferTag$3:
      return !(
        ee.byteLength != _.byteLength ||
        !ne(new Uint8Array$1(ee), new Uint8Array$1(_))
      );
    case boolTag$3:
    case dateTag$3:
    case numberTag$3:
    ...
    case setTag$5:
      ...
      if ((ie || (ie = setToArray$2), ee.size != _.size && !le)) return !1;
      var ce = oe.get(ee);
      if (ce) return ce == _;
...
function arrayFilter$1(ee, _) {
  for (
    var te = -1, re = ee == null ? 0 : ee.length, ae = 0, ne = [];
    ++te < re;
...
function isLength$3(ee) {
  return (
    typeof ee == "number" && ee > -1 && ee % 1 == 0 && ee <= MAX_SAFE_INTEGER
  );
}
...
function baseIsTypedArray$1(ee) {
  return (
    isObjectLike$4(ee) &&
    isLength$2(ee.length) &&
    !!typedArrayTags[baseGetTag$2(ee)]
  );
}
...
function arrayLikeKeys$2(ee, _) {
  var te = isArray$7(ee),
    ...
    ne = !te && !re && !ae && isTypedArray$1(ee),
    oe = te || re || ae || ne,
    ie = oe ? baseTimes(ee.length, String) : [],
    le = ie.length;
  for (var ce in ee)
    (_ || hasOwnProperty$6.call(ee, ce)) &&
      !(
        oe &&
        (ce == "length" ||
          (ae && (ce == "offset" || ce == "parent")) ||
          (ne &&
...
function equalObjects$1(ee, _, te, re, ae, ne) {
  var oe = te & COMPARE_PARTIAL_FLAG$3,
    ie = getAllKeys$1(ee),
    le = ie.length,
    ce = getAllKeys$1(_),
    se = ce.length;
  if (le != se && !oe) return !1;
  for (var de = le; de--; ) {
    var pe = ie[de];
    if (!(oe ? pe in _ : hasOwnProperty$4.call(_, pe))) return !1;
  }
  var me = ne.get(ee),
    ue = ne.get(_);
  if (me && ue) return me == _ && ue == ee;
  var he = !0;
  ...
  for (var fe = oe; ++de < le; ) {
    ...
    var ge = ee[pe],
      ve = _[pe];
    if (re) var ye = oe ? re(ve, ge, pe, _, ee, ne) : re(ge, ve, pe, ee, _, ne);
  ...
  return ne.delete(ee), ne.delete(_), he;
}
...
((DataView$2 &&
  getTag$4(new DataView$2(new ArrayBuffer(1))) != dataViewTag$2) ||
...
function baseIsEqualDeep$1(ee, _, te, re, ae, ne) {
  var oe = isArray$6(ee),
    ie = isArray$6(_),
    le = oe ? arrayTag$1 : getTag$3(ee),
    ce = ie ? arrayTag$1 : getTag$3(_);
  (le = le == argsTag$1 ? objectTag$1 : le),
    (ce = ce == argsTag$1 ? objectTag$1 : ce);
  var se = le == objectTag$1,
    de = ce == objectTag$1,
    pe = le == ce;
  if (pe && isBuffer$1(ee)) {
  ...
  if (pe && !se)
    return (
      ne || (ne = new Stack$2()),
      oe || isTypedArray(ee)
        ? equalArrays(ee, _, te, re, ae, ne)
        : equalByTag(ee, _, le, te, re, ae, ne)
    );
  if (!(te & COMPARE_PARTIAL_FLAG$2)) {
    var me = se && hasOwnProperty$3.call(ee, "__wrapped__"),
      ue = de && hasOwnProperty$3.call(_, "__wrapped__");
    if (me || ue) {
      var he = me ? ee.value() : ee,
        fe = ue ? _.value() : _;
      return ne || (ne = new Stack$2()), ae(he, fe, te, re, ne);
    }
  }
  return pe
    ? (ne || (ne = new Stack$2()), equalObjects(ee, _, te, re, ae, ne))
    : !1;
}
...
function baseIsMatch$1(ee, _, te, re) {
  ...
  for (ee = Object(ee); ae--; ) {
    var ie = te[ae];
    if (oe && ie[2] ? ie[1] !== ee[ie[0]] : !(ie[0] in ee)) return !1;
  }
  for (; ++ae < ne; ) {
    ie = te[ae];
    var le = ie[0],
      ...
      se = ie[1];
    if (oe && ie[2]) {
      if (ce === void 0 && !(le in ee)) return !1;
    } else {
      var de = new Stack$1();
      if (re) var pe = re(ce, se, le, ee, _, de);
      if (
        !(pe === void 0
          ? baseIsEqual$1(
              se,
...
function isSymbol$3(ee) {
  return (
    _typeof(ee) == "symbol" ||
    (isObjectLike$2(ee) && baseGetTag(ee) == symbolTag$2)
  );
}
...
function isKey$3(ee, _) {
  ...
  return te == "number" ||
    ...
    isSymbol$2(ee)
    ? !0
    : reIsPlainProp.test(ee) ||
        !reIsDeepProp.test(ee) ||
        (_ != null && ee in Object(_));
}
var _isKey = isKey$3,
  MapCache = _MapCache,
...
var _memoizeCapped = memoizeCapped$1,
  ...
  stringToPath$1 = memoizeCapped(function (ee) {
    ...
    return (
      ...
      ee.replace(rePropName, function (te, re, ae, ne) {
...
function assignValue$3(ee, _, te) {
  var re = ee[_];
  (!(hasOwnProperty$2.call(ee, _) && eq(re, te)) ||
    (te === void 0 && !(_ in ee))) &&
...
function baseSet$1(ee, _, te, re) {
  ...
  _ = castPath$1(_, ee);
  for (
    var ae = -1, ne = _.length, oe = ne - 1, ie = ee;
    ie != null && ++ae < ne;
    ...
    if (ae != oe) {
      var se = ie[le];
      (ce = re ? re(se, le, ie) : void 0),
        ce === void 0 &&
          (ce = isObject$3(se) ? se : isIndex(_[ae + 1]) ? [] : {});
    }
...
function baseKeysIn$1(ee) {
  ...
  var _ = isPrototype$1(ee),
    te = [];
  for (var re in ee)
    (re == "constructor" && (_ || !hasOwnProperty$1.call(ee, re))) ||
      te.push(re);
  return te;
}
...
var pickBy_1 = pickBy,
  ...
  ArgJsDoc = function (_) {
    var te = _.tags,
      re = (te.params || []).filter(function (oe) {
        return oe.description;
      }),
      ae = re.length !== 0,
      ne = te.returns != null && te.returns.description != null;
    return !ae && !ne
      ? null
      : React__default.createElement(
          Table,
              ...
              re.map(function (oe) {
                return React__default.createElement(
                  ...
                  React__default.createElement(
                    "td",
                    null,
                    React__default.createElement("code", null, oe.name)
                  ),
...
function baseUniq$1(ee, _, te) {
  var re = -1,
    ...
    ie = [],
    le = ie;
  if (te) (oe = !1), (ae = arrayIncludesWith);
  ...
  e: for (; ++re < ne; ) {
    ...
    if (((se = te || se !== 0 ? se : 0), oe && de === de)) {
      for (var pe = le.length; pe--; ) if (le[pe] === de) continue e;
      _ && le.push(de), ie.push(se);
    } else ae(le, de, te) || (le !== ie && le.push(de), ie.push(se));
  }
  return ie;
}
...
var uniq_1 = uniq,
  ...
  ArgSummary = function (_) {
    var te = _.value,
      ...
      ae = te.summary,
      ne = te.detail,
      oe = react.exports.useState(!1),
      ie = _slicedToArray$4(oe, 2),
      le = ie[0],
      ce = ie[1],
      se = react.exports.useState(re || !1),
      de = _slicedToArray$4(se, 2),
      pe = de[0],
      me = de[1];
    ...
    if (ne == null) {
      var he = /[(){}[\]<>]/.test(ue);
      if (he) return React__default.createElement(ArgText, { text: ue });
      var fe = getSummaryItems(ue),
        ge = fe.length,
        ve = ge > ITEMS_BEFORE_EXPANSION;
      return ve
        ? React__default.createElement(
            Summary,
            { isExpanded: pe },
            renderSummaryItems(fe, pe),
            React__default.createElement(
              ExpandButton,
              {
                onClick: function () {
              ...
              pe
                ? "Show less..."
                : "Show ".concat(ge - ITEMS_BEFORE_EXPANSION, " more...")
            )
          )
        : React__default.createElement(Summary, null, renderSummaryItems(fe));
    }
    return React__default.createElement(
      WithTooltipPure,
      {
        ...
        placement: "bottom",
        tooltipShown: le,
        onVisibilityChange: function (be) {
          ce(be);
        },
      ...
      React__default.createElement(
        ...
        React__default.createElement("span", null, ue),
        React__default.createElement(ArrowIcon, {
          icon: le ? "arrowup" : "arrowdown",
        })
      )
    );
  },
  ...
  Label$3 = styled.label(function (ee) {
    ...
    return {
      ...
      span: {
        ...
        "&:hover": {
          boxShadow: "".concat(
            curriedOpacify$1(0.3, _.appBorderColor),
            " 0 0 0 1px inset"
          ),
        },
        "&:active": {
          boxShadow: "".concat(
            curriedOpacify$1(0.05, _.appBorderColor),
            " 0 0 0 2px inset"
          ),
      ...
      "input:checked ~ span:last-of-type, input:not(:checked) ~ span:first-of-type":
        {
          ...
          boxShadow: "".concat(
            curriedOpacify$1(0.1, _.appBorderColor),
            " 0 0 2px"
          ),
          color: _.color.defaultText,
          padding: "7px 15px",
  ...
  BooleanControl = function (_) {
    ...
    if (re === void 0)
      return React__default.createElement(
        Form.Button,
        { id: getControlSetterButtonId(te), onClick: ie },
        "Set boolean"
      );
    var le = typeof re == "string" ? parse$2(re) : re;
    return React__default.createElement(
      Label$3,
      { htmlFor: te, title: le ? "Change to false" : "Change to true" },
      React__default.createElement(
        "input",
        Object.assign(
          {
  ...
  parseDate = function (_) {
    var te = _.split("-"),
      ...
      ie = new Date();
    return (
      ie.setFullYear(parseInt(ae, 10), parseInt(ne, 10) - 1, parseInt(oe, 10)),
      ie
    );
  },
  ...
  formatDate = function (_) {
    var te = new Date(_),
      ...
      ne = "0".concat(te.getDate()).slice(-2);
  ...
  DateControl = function (_) {
    var te = _.name,
      ...
      ne = _.onFocus,
      oe = _.onBlur,
      ie = react.exports.useState(!0),
      le = _slicedToArray$4(ie, 2),
      ce = le[0],
      se = le[1],
      de = react.exports.useRef(),
      pe = react.exports.useRef();
    react.exports.useEffect(
      function () {
        ce !== !1 &&
          (de && de.current && (de.current.value = formatDate(re)),
          pe && pe.current && (pe.current.value = formatTime(re)));
      },
      [re]
    );
    var me = function (ge) {
        var ve = parseDate(ge.target.value),
          ye = new Date(re);
      ...
      ue = function (ge) {
        var ve = parseTime(ge.target.value),
          ye = new Date(re);
  ...
  NumberControl = function (_) {
    var te = _.name,
      ...
      le = _.onBlur,
      ce = _.onFocus,
      se = react.exports.useState(typeof re == "number" ? re : ""),
      de = _slicedToArray$4(se, 2),
      pe = de[0],
      me = de[1],
      ue = react.exports.useState(!1),
      he = _slicedToArray$4(ue, 2),
      fe = he[0],
      ge = he[1],
      ve = react.exports.useState(null),
      ...
      $e = react.exports.useCallback(
        function (Ee) {
          me(Ee.target.value);
          var Te = parseFloat(Ee.target.value);
          Number.isNaN(Te)
            ? Se(new Error("'".concat(Ee.target.value, "' is not a number")))
            : (ae(Te), Se(null));
        },
        [ae, Se]
      ),
      _e = react.exports.useCallback(
        function () {
          me("0"), ae(0), ge(!0);
        },
        [ge]
      ),
      xe = react.exports.useRef(null);
    return (
      react.exports.useEffect(
        function () {
          fe && xe.current && xe.current.select();
        },
        [fe]
      ),
      react.exports.useEffect(
        function () {
          var Ee = typeof re == "number" ? re : "";
          pe !== Ee && me(re);
        },
        [re]
      ),
      !fe && re === void 0
        ? React__default.createElement(
            Form.Button,
            { id: getControlSetterButtonId(te), onClick: _e },
            "Set number"
          )
        : React__default.createElement(
            Wrapper$5,
...
var selectedKey = function (_, te) {
  ...
  CheckboxControl = function (_) {
    ...
    var ie = selectedKeys(ae, re),
      le = react.exports.useState(ie),
      ce = _slicedToArray$4(le, 2),
      se = ce[0],
      de = ce[1],
      pe = function (he) {
        var fe = he.target.value,
          ge = _toConsumableArray$1(se);
        ge != null && ge.includes(fe)
          ? ge.splice(ge.indexOf(fe), 1)
          : ge.push(fe),
          ne(selectedValues(ge, re)),
          de(ge);
      },
      me = getControlId(te);
    return React__default.createElement(
      Wrapper$4,
      { isInline: oe },
      Object.keys(re).map(function (ue, he) {
        var fe = "".concat(me, "-").concat(he);
        return React__default.createElement(
          Label$2,
          { key: fe, htmlFor: fe },
          React__default.createElement("input", {
            ...
            value: ue,
            onChange: pe,
            checked: se == null ? void 0 : se.includes(ue),
          }),
          React__default.createElement(Text$1, null, ue)
        );
      })
    );
  },
...
var Text = styled.span({}),
  ...
  RadioControl = function (_) {
    ...
    var ie = selectedKey(ae, re),
      le = getControlId(te);
    return React__default.createElement(
      Wrapper$3,
      { isInline: oe },
      Object.keys(re).map(function (ce, se) {
        ...
        return React__default.createElement(
          ...
          React__default.createElement("input", {
            ...
            onChange: function (me) {
              return ne(re[me.currentTarget.value]);
            },
            checked: ce === ie,
          }),
  ...
  OptionsSelect = styled.select(function (ee) {
    ...
    return Object.assign(Object.assign({}, styleResets), {
      ...
      lineHeight: "20px",
      "&:focus": {
        boxShadow: "".concat(_.color.secondary, " 0 0 0 1px inset"),
        outline: "none",
      },
      "&[disabled]": { cursor: "not-allowed", opacity: 0.5 },
...
`,
  ...
  SingleSelect = function (_) {
    var te = _.name,
      ...
      ie = selectedKey(re, ae) || NO_SELECTION,
      le = getControlId(te);
    return React__default.createElement(
      SelectWrapper,
      null,
      ...
      React__default.createElement(
        ...
        Object.keys(ae).map(function (ce) {
  ...
  MultiSelect = function (_) {
    var te = _.name,
      ...
      ne = _.onChange,
      oe = function (se) {
        var de = Array.from(se.currentTarget.options)
          .filter(function (pe) {
            return pe.selected;
          })
          .map(function (pe) {
  ...
  OptionsControl = function (_) {
    var te = _.type,
      re = te === void 0 ? "select" : te,
      ae = _.options,
      ne = _.labels,
      oe = _.argType,
      ie = Object.assign(Object.assign({}, _), {
        options: normalizeOptions(ae || oe.options, ne),
...
function arrayEach$1(ee, _) {
  for (
    var te = -1, re = ee == null ? 0 : ee.length;
    ++te < re && _(ee[te], te, ee) !== !1;
...
function copyObject$4(ee, _, te, re) {
  ...
  for (var ne = -1, oe = _.length; ++ne < oe; ) {
    var ie = _[ne],
      le = re ? re(te[ie], ee[ie], ie, te, ee) : void 0;
    le === void 0 && (le = ee[ie]),
      ae ? baseAssignValue(te, ie, le) : assignValue$1(te, ie, le);
  }
  return te;
}
...
(function (ee, _) {
  var te = _root,
    ...
    ae = re && !0 && ee && !ee.nodeType && ee,
    ne = ae && ae.exports === re,
    oe = ne ? te.Buffer : void 0,
    ie = oe ? oe.allocUnsafe : void 0;
  function le(ce, se) {
    if (se) return ce.slice();
    var de = ce.length,
      pe = ie ? ie(de) : new ce.constructor(de);
    return ce.copy(pe), pe;
  }
  ee.exports = le;
...
function initCloneObject$1(ee) {
  return typeof ee.constructor == "function" && !isPrototype(ee)
    ? baseCreate(getPrototype(ee))
    : {};
}
...
function baseClone$1(ee, _, te, re, ae, ne) {
  var oe,
    ie = _ & CLONE_DEEP_FLAG$1,
    le = _ & CLONE_FLAT_FLAG,
    ce = _ & CLONE_SYMBOLS_FLAG$1;
  if ((te && (oe = ae ? te(ee, re, ae, ne) : te(ee)), oe !== void 0)) return oe;
  if (!isObject(ee)) return ee;
  var se = isArray(ee);
  if (se) {
    if (((oe = initCloneArray(ee)), !ie)) return copyArray(ee, oe);
  } else {
    var de = getTag(ee),
      pe = de == funcTag || de == genTag;
    if (isBuffer(ee)) return cloneBuffer(ee, ie);
    if (de == objectTag || de == argsTag || (pe && !ae)) {
      if (((oe = le || pe ? {} : initCloneObject(ee)), !ie))
        return le
          ? copySymbolsIn(ee, baseAssignIn(oe, ee))
          : copySymbols(ee, baseAssign(oe, ee));
    } else {
      if (!cloneableTags[de]) return ae ? ee : {};
  ...
  ne.set(ee, oe),
    isSet(ee)
      ? ee.forEach(function (fe) {
          oe.add(baseClone$1(fe, _, te, fe, ee, ne));
        })
      : isMap(ee) &&
        ee.forEach(function (fe, ge) {
          oe.set(ge, baseClone$1(fe, _, te, ge, ee, ne));
        });
  var ue = ce ? (le ? getAllKeysIn : getAllKeys) : le ? keysIn : keys,
    he = se ? void 0 : ue(ee);
  return (
    arrayEach(he || ee, function (fe, ge) {
      he && ((ge = fe), (fe = ee[ge])),
        assignValue(oe, ge, baseClone$1(fe, _, te, ge, ee, ne));
    }),
    oe
  );
}
    ...
    _createClass(te, [
        ...
        value: function (ae) {
          ae.altKey ||
            ...
            ((ae.code === "Enter" || ae.key === "Enter") &&
              (ae.preventDefault(), this.onSubmit()),
      ...
      },
      {
        ...
        value: function () {
          ...
          (me.newValue = ie(!1, le, ce, me.key, pe.value)), ne(me);
        },
      },
      {
        key: "refInputKey",
      ...
      },
      {
        ...
        value: function () {
          var ae = this.props,
            ne = ae.handleCancel,
            oe = ae.onlyValue,
            ie = ae.addButtonElement,
            le = ae.cancelButtonElement,
            ce = ae.inputElementGenerator,
            se = ae.keyPath,
            de = ae.deep,
            pe = react.exports.cloneElement(ie, { onClick: this.onSubmit }),
            me = react.exports.cloneElement(le, { onClick: ne }),
            ue = ce(VALUE, se, de),
            he = react.exports.cloneElement(ue, {
              placeholder: "Value",
          ...
          if (!oe) {
            var ge = ce(KEY, se, de);
            fe = react.exports.cloneElement(ge, {
              placeholder: "Key",
  ...
  function te(re) {
    ...
    return (
      (ae.state = {
        ...
        deep: re.deep,
        nextDeep: re.deep + 1,
        collapsed: re.isCollapsed(ne, re.deep, re.data),
        addFormVisible: !1,
      }),
      (ae.handleCollapseMode = ae.handleCollapseMode.bind(
        _assertThisInitialized2(ae)
      )),
      (ae.handleRemoveItem = ae.handleRemoveItem.bind(
        _assertThisInitialized2(ae)
      )),
      (ae.handleAddMode = ae.handleAddMode.bind(_assertThisInitialized2(ae))),
      (ae.handleAddValueAdd = ae.handleAddValueAdd.bind(
        _assertThisInitialized2(ae)
      )),
      (ae.handleAddValueCancel = ae.handleAddValueCancel.bind(
        _assertThisInitialized2(ae)
      )),
      (ae.handleEditValue = ae.handleEditValue.bind(
        _assertThisInitialized2(ae)
      )),
      (ae.onChildUpdate = ae.onChildUpdate.bind(_assertThisInitialized2(ae))),
      (ae.renderCollapsed = ae.renderCollapsed.bind(
        _assertThisInitialized2(ae)
      )),
      (ae.renderNotCollapsed = ae.renderNotCollapsed.bind(
        _assertThisInitialized2(ae)
      )),
      ae
    );
        ...
        },
        {
          ...
          value: function (ae) {
            var ne = this,
              ...
              se = ie.nextDeep,
              de = this.props,
              pe = de.beforeAddAction,
              me = de.logger;
            pe(le.length, ce, se, oe)
              .then(function () {
        ...
        },
        {
          ...
          value: function (ae) {
            ...
            return new Promise(function (le, ce) {
              var se = ne.props.beforeUpdateAction,
                de = ne.state,
                pe = de.data,
                me = de.keyPath,
                ue = de.nextDeep,
        ...
        },
        {
          ...
          value: function () {
            var ae = this.state,
              ...
              pe = ce.getStyle,
              me = ce.dataType,
              ue = ce.minusMenuElement,
              he = pe(ne, oe, ie, le, me),
              fe = he.minus,
              ge = he.collapsed,
              ve = de(ne, oe, ie, le, me),
              ye = react.exports.cloneElement(ue, {
                onClick: se,
        ...
        },
        {
          ...
          value: function () {
            var ae = this,
              ...
              ge = pe.getStyle,
              ve = pe.dataType,
              ye = pe.addButtonElement,
              be = pe.cancelButtonElement,
              Se = pe.editButtonElement,
              $e = pe.inputElementGenerator,
              _e = pe.textareaElementGenerator,
              xe = pe.minusMenuElement,
              Ee = pe.plusMenuElement,
              Te = pe.beforeRemoveAction,
              Ce = pe.beforeAddAction,
              Ae = pe.beforeUpdateAction,
              Re = pe.logger,
              we = pe.onSubmitValueParser,
              Oe = ge(oe, ie, le, ce, ve),
              Le = Oe.minus,
              Ne = Oe.plus,
              je = Oe.delimiter,
              Fe = Oe.ul,
              Me = Oe.addForm,
              Ie = fe(oe, ie, le, ce, ve),
              ke = react.exports.cloneElement(Ee, {
                onClick: this.handleAddMode,
                className: "rejt-plus-menu",
                style: Ne,
              }),
              Be = react.exports.cloneElement(xe, {
                onClick: ue,
                className: "rejt-minus-menu",
                style: Le,
              }),
              ...
              React__default.createElement(
                ...
                ie.map(function (Ve, ze) {
                  return React__default.createElement(JsonNode, {
                    ...
                    deep: de,
                    isCollapsed: me,
                    handleRemove: ae.handleRemoveItem(ze),
                    ...
                    getStyle: ge,
                    addButtonElement: ye,
                    cancelButtonElement: be,
                    editButtonElement: Se,
                    inputElementGenerator: $e,
                    textareaElementGenerator: _e,
                    minusMenuElement: xe,
                    plusMenuElement: Ee,
                    beforeRemoveAction: Te,
                    beforeAddAction: Ce,
        ...
        },
        {
          ...
          value: function () {
            var ae = this.state,
              ...
              de = se.dataType,
              pe = se.getStyle,
              me = oe ? this.renderCollapsed() : this.renderNotCollapsed(),
              ue = pe(ne, ie, le, ce, de);
            return React__default.createElement(
              "div",
              ...
              React__default.createElement(
                ...
                React__default.createElement(
                  "span",
                  { className: "rejt-name", style: ue.name },
                  ne,
                  " :",
                  " "
                )
...
var JsonFunctionValue = (function (ee) {
  ...
  function te(re) {
    ...
    return (
      ...
      (ae.handleCancelEdit = ae.handleCancelEdit.bind(
        _assertThisInitialized2(ae)
      )),
        ...
        },
        {
          ...
          value: function () {
            var ae = this,
              ...
              ue = de.deep;
            if (!!pe) {
              var he = ce(!0, se, ue, me, pe.value),
                fe = { value: he, key: me };
              oe(fe)
                .then(function () {
                  isComponentWillChange(ie, he) || ae.handleCancelEdit();
                })
                .catch(le.error);
            }
          },
        ...
        },
        {
          ...
          value: function () {
            var ae = this.state,
              ...
              ue = se.dataType,
              he = se.getStyle,
              fe = se.editButtonElement,
              ge = se.cancelButtonElement,
              ve = se.textareaElementGenerator,
              ye = se.minusMenuElement,
              be = se.keyPath,
              Se = he(ne, pe, le, ce, ue),
              $e = null,
              _e = null,
              xe = me(ne, pe, le, ce, ue);
            if (ie && !xe) {
              var Ee = ve(VALUE, be, ce, ne, pe, ue),
                Te = react.exports.cloneElement(fe, {
                  onClick: this.handleEdit,
                }),
                Ce = react.exports.cloneElement(ge, {
              ...
              ($e = React__default.createElement(
                "span",
                { className: "rejt-edit-form", style: Se.editForm },
                Ae,
                " ",
                Ce,
                Te
              ...
              $e = React__default.createElement(
                "span",
                {
                  ...
                  style: Se.value,
                  onClick: xe ? null : this.handleEditMode,
                },
                oe
              );
              var Re = react.exports.cloneElement(ye, {
                onClick: de,
                className: "rejt-minus-menu",
                style: Se.minus,
              });
            ...
            return React__default.createElement(
              "li",
              { className: "rejt-function-value-node", style: Se.li },
              React__default.createElement(
                "span",
                { className: "rejt-name", style: Se.name },
                ne,
                " :",
                " "
              ),
      ...
      [
        {
          ...
          value: function () {
            var ae = this.state,
              ...
              se = ce.isCollapsed,
              de = ce.handleRemove,
              pe = ce.handleUpdateValue,
              me = ce.onUpdate,
              ue = ce.onDeltaUpdate,
              he = ce.readOnly,
              fe = ce.getStyle,
              ge = ce.addButtonElement,
              ve = ce.cancelButtonElement,
              ye = ce.editButtonElement,
              be = ce.inputElementGenerator,
              Se = ce.textareaElementGenerator,
              $e = ce.minusMenuElement,
              _e = ce.plusMenuElement,
              xe = ce.beforeRemoveAction,
              Ee = ce.beforeAddAction,
              Te = ce.beforeUpdateAction,
              Ce = ce.logger,
              Ae = ce.onSubmitValueParser,
              Re = function () {
                return !0;
              },
              we = getObjectType(ne);
            switch (we) {
              case ERROR:
                return React__default.createElement(JsonObject, {
                  ...
                  getStyle: fe,
                  addButtonElement: ge,
                  cancelButtonElement: ve,
                  editButtonElement: ye,
                  inputElementGenerator: be,
                  textareaElementGenerator: Se,
                  minusMenuElement: $e,
                  plusMenuElement: _e,
                  beforeRemoveAction: xe,
                  beforeAddAction: Ee,
...
var JsonObject = (function (ee) {
  ...
  function te(re) {
    ...
    var ne =
      re.deep === -1
        ? []
        : [].concat(_toConsumableArray$1(re.keyPath), [re.name]);
    return (
      (ae.state = {
        name: re.name,
        data: re.data,
      ...
      (ae.handleRemoveValue = ae.handleRemoveValue.bind(
        _assertThisInitialized2(ae)
      )),
      (ae.handleAddMode = ae.handleAddMode.bind(_assertThisInitialized2(ae))),
      (ae.handleAddValueAdd = ae.handleAddValueAdd.bind(
        ...
        },
        {
          ...
          value: function (ae) {
            var ne = this,
              ...
              de = le.nextDeep,
              pe = this.props,
              me = pe.beforeAddAction,
              ue = pe.logger;
            me(oe, se, de, ie)
              .then(function () {
                (ce[oe] = ie),
                  ne.setState({ data: ce }),
                  ne.handleAddValueCancel();
                var he = ne.props,
                  fe = he.onUpdate,
                  ge = he.onDeltaUpdate;
                fe(se[se.length - 1], ce),
                  ge({
                    type: ADD_DELTA_TYPE,
                    keyPath: se,
                    deep: de,
        ...
        },
        {
          ...
          value: function () {
            var ae = this.state,
              ...
              me = ce.getStyle,
              ue = ce.minusMenuElement,
              he = me(ne, le, oe, ie, pe),
              fe = he.minus,
              ge = he.collapsed,
              ve = Object.getOwnPropertyNames(le),
              ye = de(ne, le, oe, ie, pe),
              be = react.exports.cloneElement(ue, {
                onClick: se,
                className: "rejt-minus-menu",
                style: fe,
              });
        ...
        },
        {
          ...
          value: function () {
            var ae = this,
              ...
              Fe = Oe.ul,
              Me = Oe.delimiter,
              Ie = Object.getOwnPropertyNames(ie),
              ke = fe(oe, ie, le, ce, ve),
              Be = react.exports.cloneElement(Ee, {
                onClick: this.handleAddMode,
                className: "rejt-plus-menu",
                style: Ne,
              }),
              De = react.exports.cloneElement(xe, {
                onClick: ue,
                className: "rejt-minus-menu",
                style: Le,
              }),
              Pe = Ie.map(function (ze) {
                return React__default.createElement(JsonNode, {
                  key: ze,
                  name: ze,
                  data: ie[ze],
                  ...
                  deep: se,
                  isCollapsed: me,
                  handleRemove: ae.handleRemoveValue(ze),
                  handleUpdateValue: ae.handleEditValue,
                  onUpdate: ae.onChildUpdate,
                  onDeltaUpdate: he,
                  readOnly: fe,
        ...
        },
        {
          ...
          value: function () {
            var ae = this.state,
              ...
              fe = se.editButtonElement,
              ge = se.cancelButtonElement,
              ve = se.inputElementGenerator,
              ye = se.minusMenuElement,
              be = se.keyPath,
              Se = he(ne, pe, le, ce, ue),
              $e = me(ne, pe, le, ce, ue),
              _e = ie && !$e,
              xe = ve(VALUE, be, ce, ne, pe, ue),
              Ee = react.exports.cloneElement(fe, { onClick: this.handleEdit }),
              Te = react.exports.cloneElement(ge, {
                onClick: this.handleCancelEdit,
              }),
              Ce = react.exports.cloneElement(xe, {
                ref: this.refInput,
                defaultValue: JSON.stringify(pe),
              }),
              Ae = react.exports.cloneElement(ye, {
                onClick: de,
                className: "rejt-minus-menu",
                style: Se.minus,
              });
            return React__default.createElement(
              "li",
              { className: "rejt-value-node", style: Se.li },
              React__default.createElement(
                "span",
                { className: "rejt-name", style: Se.name },
                ne,
        ...
        },
        {
          ...
          value: function () {
            var ae = this.state,
              ...
              me = ie.cancelButtonElement,
              ue = ie.editButtonElement,
              he = ie.inputElement,
              fe = ie.textareaElement,
              ge = ie.minusMenuElement,
              ve = ie.plusMenuElement,
              ye = ie.beforeRemoveAction,
              be = ie.beforeAddAction,
              Se = ie.beforeUpdateAction,
              $e = ie.logger,
              _e = ie.onSubmitValueParser,
              xe = ie.fallback,
              Ee = xe === void 0 ? null : xe,
              Te = getObjectType(ne),
              Ce = se;
            getObjectType(se) === "Boolean" &&
              (Ce = function () {
                return se;
              });
            var Ae = he;
              ...
              Te === "Object" || Te === "Array"
                ? React__default.createElement(
                    ...
                    React__default.createElement(JsonNode, {
                      ...
                      getStyle: de,
                      addButtonElement: pe,
                      cancelButtonElement: me,
                      editButtonElement: ue,
                      inputElementGenerator: Ae,
                      textareaElementGenerator: Re,
                      minusMenuElement: ge,
                      plusMenuElement: ve,
                      handleRemove: this.removeRoot,
                      beforeRemoveAction: ye,
                      beforeAddAction: be,
                      beforeUpdateAction: Se,
                      logger: $e,
                      onSubmitValueParser: _e,
                    })
                  )
                : Ee
            );
      ...
      [
        {
          key: "getDerivedStateFromProps",
          value: function (ae, ne) {
            return ae.data !== ne.data || ae.rootName !== ne.rootName
...
var globalWindow$3 = window_1.window,
  ...
  ActionIcon = styled(Icons)(function (ee) {
    ...
    return {
      ...
      "&:hover": re
        ? {}
        : { color: te === "subtract" ? _.color.negative : _.color.ancillary },
      "svg + &": { marginLeft: 0 },
    };
  }),
  ...
  dispatchEnterKey = function ee(_) {
    _.currentTarget.dispatchEvent(
      new globalWindow$3.KeyboardEvent("keydown", ENTER_EVENT)
    );
  },
  ...
  ObjectControl = function ee(_) {
    var te = _.name,
      ...
      se = ce[0],
      de = ce[1],
      pe = react.exports.useState(null),
      me = _slicedToArray$4(pe, 2),
      ue = me[0],
      he = me[1],
      fe = react.exports.useCallback(
        function (xe) {
          try {
            xe && ae(JSON.parse(xe)), he(void 0);
          } catch (Ee) {
            he(Ee);
          }
        },
    ...
    if (
      ...
      return React__default.createElement(
        Form.Button,
        { id: getControlSetterButtonId(te), onClick: Se },
        "Set object"
      );
    var _e = React__default.createElement(RawInput, {
      ref: $e,
      id: getControlId(te),
      name: te,
      defaultValue: re === null ? "" : JSON.stringify(re, null, 2),
      onBlur: function (Ee) {
        return fe(Ee.target.value);
      },
    ...
    return React__default.createElement(
      ...
      ["Object", "Array"].includes(getObjectType(oe)) &&
        React__default.createElement(
          ...
          {
            onClick: function () {
              return de(function (Ee) {
                return !Ee;
              });
            },
          },
          React__default.createElement(Icons, {
            icon: se ? "eyeclose" : "eye",
          }),
      ...
      se
        ...
        : React__default.createElement(JsonTree, {
            ...
            inputElement: function (Ee, Te, Ce, Ae) {
              return Ae
                ? React__default.createElement(Input, {
                    onFocus: selectValue,
  ...
  RangeInput = styled.input(function (ee) {
    ...
    return {
      ...
      "&:focus": {
        outline: "none",
        "&::-webkit-slider-runnable-track": {
          borderColor: rgba(_.color.secondary, 0.4),
        },
        "&::-webkit-slider-thumb": {
...
var RangeControl = function ee(_) {
    ...
    return React__default.createElement(
      ...
      React__default.createElement(
        RangeInput,
        Object.assign(
          { id: getControlId(te), type: "range", onChange: me },
          {
            name: te,
            value: re,
            min: oe,
  ...
  TextControl = function ee(_) {
    ...
    if (re === void 0)
      return React__default.createElement(
        Form.Button,
        { id: getControlSetterButtonId(te), onClick: pe },
        "Set string"
      );
    var me = typeof re == "string";
    return React__default.createElement(
      Wrapper$1,
      null,
      React__default.createElement(
        ...
        Object.assign(
          ...
          { name: te, value: me ? re : "", onFocus: ne, onBlur: oe }
        )
      )
    );
  },
...
var FilesControl = function ee(_) {
  ...
  LazyColorControl = react.exports.lazy(function () {
    return __vitePreload(
      () => import("./Color-f953d088.9b1c0446.js"),
      [
        "assets/Color-f953d088.9b1c0446.js",
        "assets/iframe.657ba62d.js",
        "assets/es.map.constructor.3fc5bb37.js",
        "assets/jsx-runtime.9dff8acf.js",
        "assets/string.dd967029.js",
  ...
  ArgControl = function ee(_) {
    var te = _.row,
      ...
      ce = le[0],
      se = le[1],
      de = react.exports.useState({ value: re }),
      pe = _slicedToArray$4(de, 2),
      me = pe[0],
      ue = pe[1];
    react.exports.useEffect(
      function () {
    ...
    var he = react.exports.useCallback(
        function (be) {
          return ue({ value: be }), ae(_defineProperty2({}, ne, be)), be;
        },
        [ae, ne]
      ),
      fe = react.exports.useCallback(function () {
        return se(!1);
      }, []),
      ge = react.exports.useCallback(function () {
        return se(!0);
      }, []);
    ...
    var ve = {
      ...
      ye = Controls[oe.type] || NoControl;
    return React__default.createElement(
      ye,
      Object.assign({}, ve, oe, { controlType: oe.type })
    );
  },
  ...
  ArgRow = function ee(_) {
    var te,
      ...
      se = re.table || {},
      de = se.type || re.type,
      pe = se.defaultValue || re.defaultValue,
      me = (te = re.type) === null || te === void 0 ? void 0 : te.required,
      ue = ce != null && ce !== "";
    return React__default.createElement(
      "tr",
      null,
              ...
              ? React__default.createElement(
                  ...
                  React__default.createElement(
                    ...
                    React__default.createElement(ArgValue, {
                      value: de,
                      initialExpandedArgs: ie,
                    })
                  ),
                  React__default.createElement(ArgJsDoc, { tags: se.jsDocTags })
                )
              : React__default.createElement(
                  Type,
                  { hasDescription: ue },
  ...
  FlexWrapper = styled.span(function (ee) {
    return (
      ee.theme, { display: "flex", lineHeight: "20px", alignItems: "center" }
    );
  }),
  ...
  SectionRow = function ee(_) {
    var te = _.level,
      ...
      ae = _.label,
      ne = _.children,
      oe = _.initialExpanded,
      ie = oe === void 0 ? !0 : oe,
      le = _.colSpan,
      ce = le === void 0 ? 3 : le,
      se = react.exports.useState(ie),
      de = _slicedToArray$4(se, 2),
      pe = de[0],
      me = de[1],
      ue = re === "subsection" ? Subsection : Section,
      he = (ne == null ? void 0 : ne.length) || 0,
      fe =
        re === "subsection"
          ? "".concat(he, " item").concat(he !== 1 ? "s" : "")
          : "",
      ge = pe ? "arrowdown" : "arrowright",
      ve = ""
        .concat(pe ? "Hide" : "Show", " ")
        .concat(re === "subsection" ? he : ae, " item")
        .concat(he !== 1 ? "s" : "");
    return React__default.createElement(
      React__default.Fragment,
      null,
      React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(
            FlexWrapper,
            null,
            React__default.createElement(ExpanderIcon, { icon: ge }),
            ae
          )
        ),
        React__default.createElement(
        ...
        "&&":
          ...
          _defineProperty2(
            ...
            _defineProperty2(_, "td:first-child, th:first-child", {
              borderTopLeftRadius: oe ? 0 : ae.appBorderRadius,
            }),
            _defineProperty2(_, "td:last-child, th:last-child", {
              borderTopRightRadius: oe ? 0 : ae.appBorderRadius,
            }),
            _)
          ),
          _defineProperty2(
            ...
            _defineProperty2(te, "td:first-child, th:first-child", {
              borderBottomLeftRadius: oe ? 0 : ae.appBorderRadius,
            }),
            _defineProperty2(te, "td:last-child, th:last-child", {
              borderBottomRightRadius: oe ? 0 : ae.appBorderRadius,
            }),
            te)
          ),
...
var sortFns = {
    ...
    requiredFirst: function ee(_, te) {
      ...
      return (
        Number(!!(!((re = te.type) === null || re === void 0) && re.required)) -
          Number(
            !!(!((ae = _.type) === null || ae === void 0) && ae.required)
          ) || _.name.localeCompare(te.name)
      );
    },
    none: void 0,
  },
  rowLoadingData = function ee(_) {
    return {
      key: _,
      name: "propertyName",
  ...
  groupRows = function ee(_, te) {
    var re = { ungrouped: [], ungroupedSubsections: {}, sections: {} };
    if (!_) return re;
    Object.entries(_).forEach(function (ie) {
      var le = _slicedToArray$4(ie, 2),
        ce = le[0],
        se = le[1],
        de = (se == null ? void 0 : se.table) || {},
        pe = de.category,
        me = de.subcategory;
      if (pe) {
        var ue = re.sections[pe] || { ungrouped: [], subsections: {} };
        if (!me) ue.ungrouped.push(Object.assign({ key: ce }, se));
        else {
          var he = ue.subsections[me] || [];
          he.push(Object.assign({ key: ce }, se)), (ue.subsections[me] = he);
        }
        re.sections[pe] = ue;
      } else if (me) {
        var fe = re.ungroupedSubsections[me] || [];
        fe.push(Object.assign({ key: ce }, se)),
          (re.ungroupedSubsections[me] = fe);
      } else re.ungrouped.push(Object.assign({ key: ce }, se));
    });
    var ae = sortFns[te],
      ne = function (le) {
        return ae
          ? Object.keys(le).reduce(function (ce, se) {
              return Object.assign(
                Object.assign({}, ce),
                _defineProperty2({}, se, le[se].sort(ae))
              );
            }, {})
          : le;
      },
      oe = {
        ...
        ungroupedSubsections: ne(re.ungroupedSubsections),
        sections: Object.keys(re.sections).reduce(function (ie, le) {
          return Object.assign(
            Object.assign({}, ie),
            _defineProperty2({}, le, {
              ungrouped: re.sections[le].ungrouped.sort(ae),
              subsections: ne(re.sections[le].subsections),
            })
          );
        }, {}),
      };
  ...
  ArgsTable$1 = function ee(_) {
    ...
    var te = _.updateArgs,
      ...
      ae = _.compact,
      ne = _.inAddonPanel,
      oe = _.initialExpandedArgs,
      ie = _.sort,
      le = ie === void 0 ? "none" : ie,
      ce = "isLoading" in _,
      se = "rows" in _ ? _ : argsTableLoadingData,
      de = se.rows,
      pe = se.args,
      me = se.globals,
      ue = groupRows(
        pickBy_1(de, function (ve) {
          var ye;
          return (
            !(
              !(
                (ye = ve == null ? void 0 : ve.table) === null || ye === void 0
              ) && ye.disable
            ) && safeIncludeConditionalArg(ve, pe || {}, me || {})
          );
        }),
        le
      );
    if (
      ue.ungrouped.length === 0 &&
      Object.entries(ue.sections).length === 0 &&
      Object.entries(ue.ungroupedSubsections).length === 0
    )
      return React__default.createElement(
        EmptyBlock,
        null,
    ...
    var he = 1;
    te && (he += 1), ae || (he += 2);
    var fe = Object.keys(ue.sections).length > 0,
      ge = {
        updateArgs: te,
        compact: ae,
        inAddonPanel: ne,
    ...
    return React__default.createElement(
      ...
      React__default.createElement(
        ...
        Object.assign(
          { "aria-hidden": ce },
          { compact: ae, inAddonPanel: ne, isLoading: ce },
        ...
        React__default.createElement(
          ...
          ue.ungrouped.map(function (ve) {
            return React__default.createElement(
              ArgRow,
              Object.assign({ key: ve.key, row: ve, arg: pe && pe[ve.key] }, ge)
            );
          }),
          Object.entries(ue.ungroupedSubsections).map(function (ve) {
            var ye = _slicedToArray$4(ve, 2),
              be = ye[0],
              Se = ye[1];
            return React__default.createElement(
              SectionRow,
              { key: be, label: be, level: "subsection", colSpan: he },
              Se.map(function ($e) {
                return React__default.createElement(
                  ArgRow,
                  Object.assign(
          ...
          Object.entries(ue.sections).map(function (ve) {
            ...
            return React__default.createElement(
              SectionRow,
              { key: be, label: be, level: "section", colSpan: he },
              Se.ungrouped.map(function ($e) {
                return React__default.createElement(
                  ArgRow,
                  Object.assign(
                    { key: $e.key, row: $e, arg: pe && pe[$e.key] },
                    ge
                  )
                );
              }),
              Object.entries(Se.subsections).map(function ($e) {
                var _e = _slicedToArray$4($e, 2),
                  xe = _e[0],
                  Ee = _e[1];
                return React__default.createElement(
                  SectionRow,
                  { key: xe, label: xe, level: "subsection", colSpan: he },
                  Ee.map(function (Te) {
                    return React__default.createElement(
                      ArgRow,
                      Object.assign(
      ...
      : React__default.createElement(
          ...
          ae.map(function (ne) {
            var oe = _slicedToArray$4(ne, 2),
              ie = oe[0],
              le = oe[1],
              ce = "prop_table_div_".concat(ie);
            return React__default.createElement(
              "div",
              { key: ce, id: ce, title: ie },
              function (se) {
                var de = se.active;
                return de
                  ? React__default.createElement(
                      ArgsTable$1,
                      Object.assign({ key: "prop_table_".concat(ie) }, le, re)
                    )
                  : null;
              }
            );
...
var Label = styled.div(function (ee) {
  ...
  Typeset = function ee(_) {
    var te = _.fontFamily,
      ...
      ae = _.fontWeight,
      ne = _.sampleText,
      oe = __rest(_, ["fontFamily", "fontSizes", "fontWeight", "sampleText"]);
    return React__default.createElement(
      Wrapper,
...
Object.keys(components$1).forEach(function (ee) {
  resetComponents[ee] = react.exports.forwardRef(function (_, te) {
    return react.exports.createElement(
      ee,
      Object.assign(Object.assign({}, _), { ref: te })
    );
  });
});
  ...
  return (
    react.exports.useEffect(function () {
      Promise.all(
        ee.map(
          (function () {
            var ie = _asyncToGenerator(
              regeneratorRuntime.mark(function le(ce) {
                var se;
                return regeneratorRuntime.wrap(function (pe) {
                  for (;;)
                    switch ((pe.prev = pe.next)) {
                      case 0:
                        return (pe.next = 2), _.loadStory(ce);
                      case 2:
                        (se = pe.sent),
                          oe(function (me) {
                            return me[ce] === se
...
var storyBlockIdFromId = function ee(_) {
  ...
  getStoryId = function ee(_, te) {
    var re = _,
      ...
      ne = _,
      oe = ne.name,
      ie = ae === CURRENT_SELECTION ? te.id : ae;
  ...
  getStoryProps = function ee(_, te, re, ae) {
    var ne = _.height,
      ...
      ce = le.docs,
      se = ce === void 0 ? {} : ce;
    if (se.disable) return null;
    var de = se.inlineStories,
      pe = de === void 0 ? !1 : de,
      me = se.iframeHeight,
      ue = me === void 0 ? 100 : me,
      he = se.prepareForInline,
      fe = typeof oe == "boolean" ? oe : pe;
    if (fe && !he)
      throw new Error(
        "Story '".concat(
          ie,
    ...
    return Object.assign(
      { inline: fe, id: te.id, height: ne || (fe ? void 0 : ue), title: ie },
      fe && {
        parameters: le,
        storyFn: function () {
          return he(ge, re.getStoryContext(te));
        },
      }
    );
  };
...
var Story = function ee(_) {
  ...
  react.exports.useEffect(
    function () {
      ...
      if (oe && ae.current) {
        var xe = ae.current;
        (_e = te.renderStoryToElement(oe, xe)), se(!1);
      }
      return function () {
        return _e && _e();
      };
  ...
  var de = makeGate(),
    pe = _slicedToArray$2(de, 2),
    me = pe[0],
    ue = pe[1],
    he = makeGate(),
    fe = _slicedToArray$2(he, 2),
    ge = fe[0],
    ve = fe[1];
  if ((react.exports.useEffect(ve), !oe)) return jsx(StorySkeleton, {});
  ...
  if (ye.inline) {
    ...
    if (
      !(
        window_1$2 !== null &&
        window_1$2 !== void 0 &&
        (be = window_1$2.FEATURES) !== null &&
        be !== void 0 &&
        be.modernInlineRender
      )
    )
      Promise.all([me, ge]).then(function () {
        ...
        children: jsxs(MDXProvider, {
          ...
          children: [
            $e
              ? jsx("style", {
                  children: "#story--"
                    .concat(oe.id, " { min-height: ")
                    .concat($e, "; transform: translateZ(0); overflow: auto }"),
                })
              : null,
            ce && jsx(StorySkeleton, {}),
            jsx("div", {
              ref: ae,
              "data-name": oe.name,
...
var getContext = function ee(_, te) {
  ...
  useArgs = function ee(_, te) {
    var re = addons.getChannel(),
      ae = getContext(_, te),
      ne = react.exports.useState(ae.args),
      oe = _slicedToArray$1(ne, 2),
      ie = oe[0],
      le = oe[1];
    react.exports.useEffect(
      function () {
        var de = function (me) {
          me.storyId === _ && le(me.args);
        };
        return (
          re.on(Events.STORY_ARGS_UPDATED, de),
          function () {
    ...
    var ce = react.exports.useCallback(
        function (de) {
      ...
      se = react.exports.useCallback(
        function (de) {
          return re.emit(Events.RESET_STORY_ARGS, { storyId: _, argNames: de });
        },
        [_]
      );
    return [ie, ce, se];
  ...
  useGlobals = function ee(_, te) {
    var re = addons.getChannel(),
      ae = getContext(_, te),
      ne = react.exports.useState(ae.globals),
      oe = _slicedToArray$1(ne, 2),
      ie = oe[0],
      le = oe[1];
    return (
      react.exports.useEffect(function () {
        ...
        return (
          re.on(Events.GLOBALS_UPDATED, ce),
          function () {
  ...
  extractComponentArgTypes = function ee(_, te, re, ae) {
    var ne = te.id,
      ...
      le = ie.parameters,
      ce = le.docs || {},
      se = ce.extractArgTypes;
    if (!se) throw new Error(ArgsTableError.ARGS_UNSUPPORTED);
    var de = se(_);
  ...
  getComponent = function ee() {
    var _ = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
      ...
      ce = ae(re),
      se = ce.component;
    if (isShortcut(oe) || isShortcut(le)) return se || null;
    if (!oe) throw new Error(ArgsTableError.NO_COMPONENT);
    return oe;
  },
  addComponentTabs = function ee(_, te, re, ae, ne, oe) {
    return Object.assign(
      {},
      _,
      mapValues_1(te, function (ie) {
        return { rows: extractComponentArgTypes(ie, re, ae, ne), sort: oe };
      })
    );
  },
  StoryTable = function ee(_) {
    ...
    try {
      ...
      switch (ne) {
        ...
        default:
          pe = lookupStoryId(ne, te);
      }
      var ue = useStory(pe, te),
        he = useArgs(pe, te),
        fe = _slicedToArray$1(he, 3),
        ge = fe[0],
        ve = fe[1],
        ye = fe[2],
        be = useGlobals(pe, te),
        Se = _slicedToArray$1(be, 1),
        $e = Se[0];
      if (!ue)
        return jsx(ArgsTable$1, {
          isLoading: !0,
          updateArgs: ve,
          resetArgs: ye,
        });
      var _e = filterArgTypes(ue.argTypes, ce, se),
        xe = getComponentName(oe) || "Story",
        Ee = _defineProperty$2({}, xe, {
          rows: _e,
          args: ge,
          globals: $e,
          updateArgs: ve,
        ...
        Te =
          _e &&
          Object.values(_e).find(function (Ce) {
            return !!(Ce != null && Ce.control);
          });
      if (
        (Te || ((ve = null), (ye = null), (Ee = {})),
        oe &&
          (!Te || le) &&
          (Ee = addComponentTabs(
            Ee,
            _defineProperty$2({}, xe, oe),
            te,
            ce,
            se
          )),
        ...
        Ee = addComponentTabs(Ee, ie, te, ce, se);
      }
      return jsx(TabbedArgsTable, { tabs: Ee, sort: de });
    } catch (Ce) {
      return jsx(ArgsTable$1, { error: Ce.message });
    }
  },
  ComponentsTable = function ee(_) {
    var te = react.exports.useContext(DocsContext),
      ...
      ne = _.exclude,
      oe = _.sort,
      ie = addComponentTabs({}, re, te, ae, ne);
    return jsx(TabbedArgsTable, { tabs: ie, sort: oe });
  },
  ArgsTable = function ee(_) {
    var te = react.exports.useContext(DocsContext),
      ...
      me = _,
      ue = me.story,
      he = pe || (oe == null ? void 0 : oe.sort),
      fe = getComponent(_, te);
    if (ue)
      return jsx(StoryTable, {
        ..._,
        component: fe,
        subcomponents: ie,
        sort: he,
    ...
    if (!de && !ie) {
      var ge;
      try {
        ge = { rows: extractComponentArgTypes(fe, te, ce, se) };
      } catch (ye) {
        ge = { error: ye.message };
      }
      return jsx(ArgsTable$1, { ...ge, sort: he });
    }
    if (de) return jsx(ComponentsTable, { ..._, components: de, sort: he });
    var ve = getComponentName(fe);
    return jsx(ComponentsTable, {
      ..._,
      components: Object.assign(_defineProperty$2({}, ve, fe), ie),
      sort: he,
    });
  };
          ...
          (ne[se] && ne[se].code === de) ||
            oe(function (me) {
              var ue = Object.assign(
                {},
                me,
                _defineProperty$1({}, se, { code: de, format: pe })
              );
              return fastDeepEqual(me, ue) ? me : ue;
            });
        };
        return (
          ie.on(SNIPPET_RENDERED, le),
          function () {
            return ie.off(SNIPPET_RENDERED, le);
          }
        );
      }, []),
      jsx(SourceContext.Provider, { value: { sources: ne }, children: te })
    );
  };
...
function extractSource(ee, _) {
  ...
  var ae = _[te.line - 1],
    ne = _[re.line - 1];
  return ae === void 0 || ne === void 0
    ? null
    : [ae.substring(te.col)].concat(
        _toConsumableArray(_.slice(te.line, re.line - 1)),
        [ne.substring(0, re.col)]
      ).join(`
`);
}
var storyIdToSanitizedStoryName = function ee(_) {
  ...
  extract = function ee(_, te) {
    var re = te.source,
      ae = te.locationsMap;
    if (!ae) return re;
    var ne = storyIdToSanitizedStoryName(_),
      oe = ae[ne];
    if (!oe) return re;
    var ie = re.split(`
`);
  ...
  enhanceSource = function ee(_) {
    var te,
      ...
      oe = ae.docs,
      ie = oe === void 0 ? {} : oe,
      le = ie.transformSource;
    if (
      !(ne != null && ne.source) ||
      ((te = ie.source) !== null && te !== void 0 && te.code)
    )
      return null;
    var ce = extract(re, ne),
      se = le ? le(ce, _) : ce;
    return { docs: combineParameters(ie, { source: { code: se } }) };
  },
  SourceState;
(function (ee) {
...
var getSourceState = function ee(_) {
  ...
  getSourceProps = function ee(_, te, re) {
    var ae = te.id,
      ...
      pe = le.format,
      me = se.ids || [ce.id || ae],
      ue = me.map(function (xe) {
        return xe === CURRENT_SELECTION ? ae : xe;
      }),
      he = useStories(ue, te);
    if (!he.every(Boolean))
      return { error: SourceError.SOURCE_UNAVAILABLE, state: SourceState.NONE };
    if (!de) {
      var fe = getStorySource(ue[0], re);
      (pe = fe.format),
        (de = ue.map(function (xe, Ee) {
          var Te = getStorySource(xe, re),
            Ce = Te.code,
            Ae = he[Ee];
          return getSnippet(Ce, Ae);
        }).join(`

`));
    }
    var ge = getSourceState(he),
      ve = ie.docs,
      ye = ve === void 0 ? {} : ve,
      be = ye.source,
      Se = be === void 0 ? {} : be,
    ...
    return de
      ? {
          ...
          state: ge,
          format: pe,
          language: _.language || _e || "jsx",
          dark: _.dark || !1,
        }
      : { error: SourceError.SOURCE_UNAVAILABLE, state: ge };
  },
...
var getPreviewProps = function ee(_, te, re) {
    var ae = _.withSource,
      ne = _.mdxSource,
      oe = _.children,
      ie = _objectWithoutProperties$1(_, _excluded$1),
      le = te.mdxComponentAnnotations,
      ce = te.mdxStoryNameToKey,
      se = ae,
      de = !1;
    if (se === SourceState.NONE) return { isLoading: de, previewProps: ie };
    if (ne)
      return {
        isLoading: de,
        previewProps: Object.assign({}, ie, {
          withSource: getSourceProps({ code: decodeURI(ne) }, te, re),
        }),
      };
    var pe = Array.isArray(oe) ? oe : [oe],
      me = pe.filter(function (ve) {
        return ve.props && (ve.props.id || ve.props.name);
      }),
      ue = me.map(function (ve) {
        return (
          ve.props.id ||
          dist.toId(
            le.id || le.title,
            dist.storyNameFromExport(ce[ve.props.name])
          )
        );
      }),
      he = getSourceProps({ ids: ue }, te, re);
    se || (se = he.state);
    var fe = ue.map(function (ve) {
        return ve === CURRENT_SELECTION ? te.id : ve;
      }),
      ge = useStories(fe, te);
    return (
      (de = ge.some(function (ve) {
        return !ve;
      })),
      {
        isLoading: de,
  ...
  Canvas = function ee(_) {
    ...
    return ne
      ...
      : jsx(MDXProvider, {
          components: resetComponents,
          children: jsx(Preview$1, { ...oe, children: ie }),
        });
  },
  DescriptionType;
(function (ee) {
...
var getNotes = function ee(_) {
  ...
  getDescriptionProps = function ee(_, te) {
    var re = _.of,
      ...
      se = ce.component,
      de = ce.parameters;
    if (oe || ne) return { markdown: oe || ne };
    var pe = de.notes,
      me = de.info,
      ue = de.docs,
      he = ue || {},
      fe = he.extractComponentDescription,
      ge = fe === void 0 ? noDescription : fe,
      ve = he.description,
      ye = re === CURRENT_SELECTION ? se : re,
      be = ve == null ? void 0 : ve.component;
    if (be) return { markdown: be };
    switch (ae) {
      case DescriptionType.INFO:
        return { markdown: getInfo(me) };
      case DescriptionType.NOTES:
        return { markdown: getNotes(pe) };
      case DescriptionType.LEGACY_5_2:
        return {
          markdown: `
`
            .concat(
              getNotes(pe) || getInfo(me) || "",
              `
...
`
      ...
      default:
        return { markdown: ge(ye, Object.assign({ component: se }, de)) };
    }
  },
...
var document$3 = window_1$2.document,
  ...
  AddContext = function ee(_) {
    ...
    return jsx(DocsContext.Provider, {
...
var A = components.a,
  AnchorInPage = function ee(_) {
    ...
    return jsx(A, {
      ...
      target: "_self",
      onClick: function (ne) {
        var oe = te.substring(1),
          ie = document$3.getElementById(oe);
        ie && navigate(te);
      },
      children: re,
    });
  ...
  AnchorMdx = function ee(_) {
    var te = _.href,
      re = _.target,
      ae = _.children,
      ne = _objectWithoutProperties(_, _excluded3);
    if (te) {
      if (te.startsWith("#"))
        return jsx(AnchorInPage, { hash: te, children: ae });
      if (re !== "_blank" && !te.startsWith("https://"))
        return jsx(A, {
          href: te,
          onClick: function (ie) {
            ie.preventDefault(),
              navigate(ie.currentTarget.getAttribute("href"));
          },
          target: re,
          ...ne,
          children: ae,
  ...
  HeaderWithOcticonAnchor = function ee(_) {
    var te = _.as,
      re = _.id,
      ae = _.children,
      ne = _objectWithoutProperties(_, _excluded4),
      oe = OcticonHeaders[te],
      ie = "#".concat(re);
    return jsxs(oe, {
      id: re,
      ...ne,
  ...
  HeaderMdx = function ee(_) {
    var te = _.as,
      re = _.id,
      ae = _.children,
      ne = _objectWithoutProperties(_, _excluded5);
    if (re)
      return jsx(HeaderWithOcticonAnchor, {
        as: te,
        id: re,
        ...ne,
        children: ae,
...
var warnStoryDescription = browser(
  ...
  DocsStory = function ee(_) {
    ...
    if (ne && de) {
      var pe;
      (se =
        (pe = de.description) === null || pe === void 0 ? void 0 : pe.story),
        se || ((se = de.storyDescription), se && warnStoryDescription());
    }
    var me = ne && re;
    return jsxs(Anchor, {
      storyId: te,
      children: [
        me && jsx(Subheading, { children: me }),
        se && jsx(DescriptionContainer, { markdown: se }),
        jsx(Canvas, {
          withToolbar: ie,
          children: jsx(Story, { id: te, parameters: ce }),
        }),
      ],
    });
  },
  ...
  Stories = function ee(_) {
    var te = _.title,
      re = _.includePrimary,
      ae = re === void 0 ? !1 : re,
      ne = react.exports.useContext(DocsContext),
      oe = ne.componentStories,
      ie = oe();
    return (
      (ie = ie.filter(function (le) {
        var ce, se;
        return !(
          (ce = le.parameters) !== null &&
          ce !== void 0 &&
          (se = ce.docs) !== null &&
          se !== void 0 &&
          se.disable
      ...
      !ie || ie.length === 0
        ...
        : jsxs(Fragment, {
            children: [
              ...
              ie.map(function (le) {
                return le && jsx(DocsStory, { ...le, expanded: !0 }, le.id);
              }),
            ],
          })
    );
...
`,
  ...
  DocsContainer = function ee(_) {
    var te = _.context,
      ...
      de = se === void 0 ? {} : se,
      pe = de.theme;
    !pe && ce.theme && (warnOptionsTheme(), (pe = ce.theme));
    var me = ensure(pe),
      ue = Object.assign({}, defaultComponents, de.components);
    return (
      react.exports.useEffect(
        function () {
          var he;
          try {
            he = new URL(globalWindow.parent.location);
          } catch {
            return;
          }
          if (he.hash) {
            var fe = document$2.getElementById(he.hash.substring(1));
            fe &&
              setTimeout(function () {
                scrollToElement(fe);
              }, 200);
            ...
            if (ge) {
              var ve = ge.parentElement.querySelectorAll('[id|="anchor-"]'),
                ye = ge;
              ve &&
                ve[0] === ge &&
                (ye = document$2.getElementById("docs-root")),
                setTimeout(function () {
...
//# sourceMappingURL=Props.53e66bbb.js.map
