...
import {U as Do, Y as zo} from "./Props.53e66bbb.js";
import "./es.number.to-fixed.04f7b86b.js";
import {b as Mo, j as Oa, r as cn} from "./jsx-runtime.9dff8acf.js";
    ...
    var zt = "OverlayScrollbars",
      ...
      Ee = (function () {
        ...
        return {
          ...
          _cssProperty: function (d) {
            ...
            for (
              var sr = u(d), w = Lr.createElement("div")[i.s], M, vr = 0, R, Er;
              vr < x.length;
              vr++
            )
              for (
                Er = x[vr].replace(/-/g, ""),
                  M = [d, x[vr] + d, Er + sr, u(Er) + sr],
                  R = 0;
                R < M[i.l];
                R++
              )
          ...
          _cssPropertyValue: function (d, B, sr) {
            ...
            for (
              ...
              for (; G < Ee._cssPrefixes[i.l]; G++)
                if (
                  ((j = G < 0 ? R[H] : Ee._cssPrefixes[G] + R[H]),
                  (vr.cssText = d + ":" + j + Er),
                  vr[i.l])
                ) {
                  M = j;
      ...
      S = (function () {
        ...
        return {
          wW: O(A, 0, !0),
          wH: O(A, 0),
          mO: O(Ee._jsAPI, 0, "MutationObserver", !0),
          rO: O(Ee._jsAPI, 0, "ResizeObserver", !0),
          rAF: O(Ee._jsAPI, 0, "requestAnimationFrame", !1, function (x) {
            return ar.setTimeout(x, 1e3 / 60);
          }),
          cAF: O(Ee._jsAPI, 0, "cancelAnimationFrame", !1, function (x) {
...
` + ar.JSON.stringify(q, null, 2)
        ...
        function d(w) {
          ...
          V.extend(M, {
            ...
            cssCalc: Ee._cssPropertyValue("width", "calc", "(1px)") || null,
            restrictedMeasuring: (function () {
              G.css(vr, R);
              var k = { w: j[i.sW], h: j[i.sH] };
              G.css(vr, "visible");
            ...
            supportTransform: !!Ee._cssProperty("transform"),
            supportTransition: !!Ee._cssProperty("transition"),
        ...
        function sr(w, M, vr, R, Er) {
          ...
          function bi() {
            T && Ea && (An.disconnect(), On.disconnect(), (Ea = !1));
          }
          function oo() {
            if (!gr) {
              var r,
            ...
            if (
              ...
              if (
                ...
                gt(W, le, [-Wr.t, -Wr.r, -Wr.b, -Wr.l]),
                  Zr
                    ? (gt(ee, K, st), gt(N ? ke : F, Me))
                    : (gt(ee, K), gt(N ? ke : F, Me, st)),
                  Xe.css(ee),
                  or.css(ke);
              }
              dr = we();
              ...
              if (
                ...
                Yr
                  ? ((W[J] = zr),
                    (F[J] =
                      Ee._cssPropertyValue(J, "max-content intrinsic") || zr),
                    (F[xe] = ir))
                  : (W[J] = K),
                ...
                if (!$) {
                  var Ca = {},
                    an = ka.y && Xt.ys && !Cr ? (Z.y ? tr.css(re) : -n.y) : 0,
                    go = ka.x && Xt.xs && !Cr ? (Z.x ? tr.css(ue) : -n.x) : 0;
                  gt(Ca, K), tr.css(Ca);
                }
                var ct = Rs(),
                ...
                if ((Mr.css(F), N && o)) {
                  ...
                  if (Pa) {
                    ...
                    (C.x = Hn.x > -1 ? (fr && Qa && k.i ? 0 : Hn.x) : C.x),
                      (C.y = Hn.y > -1 ? Hn.y : C.y);
                  }
                  si = Pa;
                }
                fr && k.i && Z.y && Tr.x && Qa && (C.x += ua.w || 0),
                  Yr && Y[he](0),
                  Br && Y[de](0),
                  tr[he](C.x)[de](C.y);
                var Ho = er === "v",
              ...
              rr &&
                ...
                (ka.c || tt.c) &&
                (tt.f || Ls(),
                Z.y && ka.x && Mr.css(Re + J, tt.w + Gr.y),
                Z.x && ka.y && Mr.css(Re + xr, tt.h + Gr.x),
                (tt.c = !1)),
                D && h.updateOnLoad && Is(),
          ...
          function Ns(r) {
            var a = ra(r),
              ...
              U;
            function cr(E) {
              return br && o ? E["screen" + h] : S.page(E)[l];
            }
            function X(E) {
            ...
            function Xr(E) {
              var Ar = E.originalEvent || E,
                kr = Ar.touches !== z;
              return gr || q || rn() || !ni || (kr && !X("touchSupport"))
                ? !1
                : S.mBtn(E) === 1 || kr;
            }
            function Zr(E) {
            ...
            ba(a._handle, Et, Ne),
              ba(a._track, [Et, Di, zi], [Rr, aa, Cr]),
              ba(a._scrollbar, Et, Ir),
              s &&
                ba(a._scrollbar, Qn, function (E) {
                  E.target === a._scrollbar[0] && (wi(r), ma(r));
                });
          }
          function Ps(r, a, t) {
            var o = r ? Ri : Wi,
          ...
          function ma(r, a) {
            var t = H(a) == _.b,
              ...
              b = h._info,
              g = "translate(",
              m = Ee._cssProperty("transform"),
              C = Ee._cssProperty("transition"),
              Q = r ? tr[he]() : tr[de](),
              P = a === z || t ? Q : a,
              er = b._handleLength,
          ...
          function po() {
            ...
            function h(C) {
              if (g(C)) {
                var Q = m(C),
                  P = {};
                (pi || kn) && (P[J] = t.w + (Q.x - a.x) * o.x),
                  (_i || kn) && (P[xr] = t.h + (Q.y - a.y) * o.y),
                  Y.css(P),
                  S.stpP(C);
              } else b(C);
            }
          ...
          function _o(r) {
            var a = Ee._cssProperty("transition"),
              t = r.css(a);
            if (t) return t;
            for (
              var o = "\\s*(([^,(]+(\\(.+?\\))?)+)[\\s,]*",
            ...
            (L.scroll = function (r, a, t, o) {
              ...
              if (Ke || en) {
                ...
                if (((Ae = Ke ? Ha : V(Ha)), Ae[Cr] > 0)) {
                  ...
                  if (
                    (fr &&
                      (!k.n && !k.i && (sa.x = I.round(ia[_r] - Br[_r] + yr.l)),
                      k.n && P && (sa.x *= -1),
                      k.i &&
                        P &&
                        (sa.x = I.round(
                    ...
                    Ar.x != Zr || Ar.y != Zr || E.x == aa || E.y == aa || fr)
                  ) {
                    var Nt = Ae[0],
                      wt = c
                        ? Nt[i.bCR]()
          ...
          function xo(r, a, t) {
            ...
            return Z.x && Z.y && !ae.nativeScrollbarsOverlaid.initialize
              ...
              : (rr &&
                  ...
                  (l = function () {
                    tr.removeAttr(i.ti), We(tr, Et, l, !0, !0);
                  })),
                Ai(),
                Oi(),
                ki(),
                ...
                rr &&
                  ...
                  Lr.activeElement == r &&
                    yt.focus &&
                    (tr.attr(i.ti, "-1"), yt.focus(), We(tr, Et, l, !1, !0))),
                L.update(zr),
                (D = !0),
                Ve("onInitialized"),
                j(Zn, function (h, b) {
        ...
        return (
          ...
          (A.extension = function (w, M, vr) {
            var R = S.type(w) == _.s,
              Er = arguments[i.l],
              H = 0;
            if (Er < 1 || !R) return V.extend(!0, { length: e[i.l] }, e);
            if (R) {
              if (S.type(M) == _.f)
...
var ln = Xs.exports,
  Vo = function (ar) {
    var Lr = ar.options,
      ...
      _ = ar.className,
      i = ar.children,
      Ee = zo(ar, ["options", "extensions", "className", "children"]),
      S = cn.exports.useRef(),
      I = cn.exports.useRef();
    return (
      ...
      Mo("div", {
        ...Object.assign({ className: "os-host" }, Ee, { ref: S }),
        children: [
...
//# sourceMappingURL=OverlayScrollbars-1355f44c.0bc4732f.js.map
