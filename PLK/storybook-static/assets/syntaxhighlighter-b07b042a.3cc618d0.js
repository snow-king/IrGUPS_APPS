import {ah as te, l as ne} from "./iframe.657ba62d.js";
import {$ as ce, _ as oe, U as yr, V as Tr, W as wr, X as le, Y as ie, Z as se,} from "./Props.53e66bbb.js";
import "./es.string.from-code-point.61b8d84d.js";
import "./es.regexp.flags.8811f768.js";
import {b as Er, j as X, r as aa} from "./jsx-runtime.9dff8acf.js";
...
function at(r, a) {
  return function (t) {
    ...
    if (!O) return Er(G, { ...H, children: [$, X(_, { ...d, children: T })] });
...
function n3(r, a) {
  var e = {},
    ...
    o;
  a || (a = {});
  for (o in ba) (t = a[o]), (e[o] = t == null ? ba[o] : t);
  return (
...
var T3 = wr.div(
  ...
  $3 = wr(function (r) {
    var a = r.children,
      e = r.className;
    return X(le, { horizontal: !0, vertical: !0, className: e, children: a });
  ...
  H3 = function (a) {
    ...
    var v = L ? L(h, e) : e.trim(),
      u = aa.exports.useState(!1),
      i = Sa(u, 2),
      g = i[0],
      y = i[1],
      w = aa.exports.useCallback(function (S) {
        S.preventDefault();
...
export {
  H3 as SyntaxHighlighter,
  N3 as createCopyToClipboardFunction,
  H3 as default,
};
//# sourceMappingURL=syntaxhighlighter-b07b042a.3cc618d0.js.map
